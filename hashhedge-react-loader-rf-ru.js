(function(){
  ...
  loadCss(base + "hashhedge-react.css?v=20260515");
  ...
  .then(function(){ return loadScript(base + "hashhedge-react-app-rf-ru.js?v=20260515"); })
  .catch(function(err){
    console.error("HashHedge RF-RU loader failed", err);
    if (root && !root.childNodes.length) {
      root.innerHTML = '<div style="min-height:320px;display:flex;align-items:center;justify-content:center;background:#08080a;color:#f5f1e8;font:600 18px system-ui,sans-serif;text-align:center;padding:32px;">HashHedge не загрузился. Обновите страницу.</div>';
    }
  });
})();
