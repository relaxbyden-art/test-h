(function(){
  ...
  function Header() {
    ...
    const nav = [
      { l: "Tentang",     h: "#about-program" },
      { l: "Cara kerja",    h: "#how" },
      { l: "Penghasilan",           h: "#calc" },
      { l: "FAQ",             h: "#faq" },
    ...
    const langs = [
      ...
      { code: "ID", flag: "🇮🇩", label: "Bahasa Indonesia", href: "#", current: true },
  ...
  function HeroCandles() {
    ...
    return _e("div", { "aria-hidden": true, className: "hh-hero-candles",
      style: { position: "absolute", inset: 0, pointerAcara: "none", zIndex: 0 }
    },
  ...
  function LivePartnerCard() {
    ...
    const payoutPool = [
      { flag: "🇷🇺", name: "Сергей",     city: "Moskow",       amt: 1850 },
    ...
    return _e("div", { className: "hh-live-card hh-glass",
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        pointerAcara: "none", zIndex: 1, borderRadius: "26px 26px 0 0"
      } }),
      ...
      _e("div", { style: { padding: "20px 22px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" } },
        ...
        _e("div", { style: { marginTop: 20 } },
          ...
          _e("div", { style: { position: "relative", height: 8, borderRadius: 6, background: "rgba(255,255,255,0.06)", overflow: "hidden", border: "1px solid rgba(255,255,255,0.04)" } },
            ...
            // Shimmer-полоска
            _e("div", { style: {
              position: "absolute", inset: "0 24% 0 0", borderRadius: 6, overflow: "hidden", pointerAcara: "none"
            } },
              _e("div", { style: {
  ...
  function Hero() {
    ...
    // matrix-стене), большой H1 в 4 строки с акцентом на «hasilkan bersama», 2 CTA,
    // ссылка «Hitung penghasilan», блок Trustpilot снизу с 4-stat ряду.
    ...
    return _e("section", {
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 2 } },
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            ...
            _e("h1", { className: "hh-partner-hero-h1",
              ...
              "Promosikan perusahaan prop", _e("br", null),
              "kripto terkemuka", _e("br", null),
              "di seluruh dunia &", _e("br", null),
              _e("span", { style: { color: "#fcd535" } }, "hasilkan bersama")
            ),
            _e("p", { className: "hh-partner-hero-sub", style: {
              ...
              " untuk setiap trader yang Anda rujuk — dibayar mingguan dalam USDT, seumur hidup."
            ),
        ...
        _e("div", { className: "hh-partner-hero-stats", style: {
          ...
          _e("div", null,
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 8, whiteSpace: "nowrap" } }, "Kemitraan dengan platform terpercaya"),
            _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10 } },
              _e("span", { style: { fontSize: 16, fontWeight: 800, color: "#f5f1e8" } }, "Sangat baik"),
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Trader funded di dunia")
          ),
          // $12M+
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Dibayarkan ke trader")
          ),
          // 4.4/5
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Negara dilayani")
          )
        )
      )
    );
  ...
  function AboutProgram() {
    const cards = [
      { v: "hingga 80%", t: "dari profit HashHedge",         b: "Revenue share tertinggi di industri per trader rujukan." },
      { v: "Mingguan", t: "pembayaran USDT",            b: "Penghasilan masuk wallet setiap Senin." },
      { v: "Seumur hidup", t: "komisi",                 b: "Anda menghasilkan selama trader tetap aktif." },
      { v: "Menit", t: "untuk disetujui",                   b: "Persetujuan cepat, formalitas minimal, link instan." }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Syarat afiliasi", _e("br", null),
                "tertinggi ", _e("span", { style: { color: "#fcd535" } }, "di industri.")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "HashHedge memberi trader kripto ", _e("strong", { style: { color: "#f5f1e8" } }, "$5,000 to $100,000"),
              " untuk trading tanpa risiko. Tugas Anda sederhana — bawa trader-trader itu. Sebagai imbalan, Anda mendapat bagian dari pendapatan mereka, dengan syarat paling murah hati yang ditawarkan perusahaan prop."
            )
          )
        ),
          ...
          cards.map((c, i) => _e(Reveal, { key: i, delay: String((i % 4) + 1) },
            _e("div", { className: "hh-about-card", style: {
              ...
              _e("div", { style: {
                ...
                marginBottom: 12,
                fontFamily: "Onest, sans-serif",
                textTransform: c.v === "hingga 80%" || c.v === "Menit" || c.v === "Seumur hidup" || c.v === "Mingguan" ? "none" : "uppercase"
              } }, c.v),
  ...
  function WhyPartner() {
    ...
    const V1 = () => isMobile
      ? _e("div", { className: "hh-v1 hh-v1-mobile", style: { width: "100%", textAlign: "center", padding: "0 4px", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" } },
          _e("div", { style: { fontSize: 38, fontWeight: 900, color: "#fcd535", lineHeight: 1, letterSpacing: "-0.03em" } }, "hingga 80%"),
    ...
    // V9 — Jaringan multi-tier. Картинка увеличена (viewBox шире), круги с непрозрачным фоном.
    const V9 = () => _e("div", { style: { width: "100%", padding: 0, position: "relative" } },
      _e("svg", { width: "100%", height: 180, viewBox: "0 0 220 130", style: { display: "block" } },
        ...
        _e("text", { x: 110, y: 33, textAnchor: "middle", style: { fontSize: 11, fontWeight: 800, fill: "#13111c" } }, "ANDA"),
    ...
    const cards = [
      { viz: _e(V1, null), chip: "Top in the prop industry", title: "Hingga 80% profit Hash Hedge", titleAccent: "before",
      ...
      { viz: _e(V2, null), chip: "One trader = lifetime income", title: "Komisi seumur hidup", titleAccent: "before",
        body: "Every trader is locked to you for life. You earn from every single purchase they make." },
      { viz: _e(V3, null), chip: "Better than exchange offers", title: "Profit lebih dari exchange",
        body: "One funded trader with a $25–50K account brings in 5–10× more than a standard exchange referral." },
      { viz: _e(V4, null), chip: "Withdrawals within 72 hours", title: "Pembayaran cepat", titleAccent: "before",
        body: "Request a USDT withdrawal any time. Funds reach your wallet within 72 hours." },
      { viz: _e(V5, null), chip: "Grow automatically", title: "7 level partner", titleAccent: "before",
      ...
      // === 3 новые карточки ===
      { viz: _e(V7, null), chip: "Discounts for your audience", title: "Kode promo untuk audiens", titleAccent: "before",
        body: "Get personal discounts for your audience to boost conversion and drive purchases through your link." },
      { viz: _e(V8, null), chip: "Traffic analytics", title: "Tracking fleksibel",
        body: "Build custom links to segment traffic and track conversions in your partner dashboard." },
      { viz: _e(V9, null), chip: "Jaringan multi-tier", title: "Program sub-afiliasi",
  ...
  function IncomeSources() {
    ...
    const sources = [
      { n: "01", title: "Komisi penjualan",
        body: _e(F, null, "Earn ", _e("b", { style: { color: "#fcd535" } }, "hingga 80%"), " of Hash Hedge profit on every purchase. Referrals are locked to you for life: bring them in once, earn from every future purchase."),
        pill: "Pendapatan berulang",
      ...
      { n: "03", title: "Program sub-afiliasi",
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 760, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Link afiliasi Anda bisa menghasilkan dari tiga sumber sekaligus.")
          )
        ),
          ...
          sources.map((s, i) => _e(Reveal, { key: i, delay: String(i + 1) },
            _e("div", { className: "hh-income-card",
              ...
              _e("div", { "aria-hidden": true, style: {
                ...
                pointerAcara: "none", userSelect: "none"
              } }, s.n),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 880, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Bawa trader and take hingga 80% of Hash Hedge profit.")
          )
        ),
        ...
        _e("div", { className: "hh-bp-wrap", style: {
            ...
            _e("div", { className: "hh-bp-track-inner", style: {
              ...
              tiers.map((t, i) => {
                ...
                return _e("button", { key: t.lvl, type: "button",
                  ...
                  "aria-label": `Level ${t.lvl} ${t.label}, комиссия ${t.pct}%`,
                  style: {
          ...
          } }, "Klik tier apa saja →  lihat detail")
        ),
        ...
        _e("div", { style: { textAlign: "center", fontSize: 13, color: "#a1a0a4" } },
          "Level recalculates automatically each month based on the number of active referred traders"
        )
      )
    );
  }
      ...
      _e("div", { className: "container" },
          ...
          _e("div", { className: "hh-calc-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { className: "hh-calc-h2", style: { fontSize: "clamp(32px, 4vw, 48px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Semakin banyak yang dibawa,", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "semakin besar bagian Anda.")
              )
            ),
        ...
        _e("div", { className: "hh-calc-grid", style: {
          ...
          _e("div", { className: "hh-calc-card", style: {
            ...
            _e("div", { style: { fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a7a80", marginBottom: 24 } }, "Kalkulator penghasilan"),
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 } },
              _e("div", { style: { fontSize: 14, color: "#a1a0a4" } }, "Trader rujukan aktif"),
            ...
            _e("div", { style: { display: "flex", gap: 12, marginTop: 28 } },
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Tier Anda"),
              ...
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Rata-rata / trader / bln"),
            ...
            _e("div", { style: { marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--line)" } },
              _e("div", { style: { fontSize: 13, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 } }, "Estimasi pembayaran bulanan"),
              ...
              _e("p", { style: { fontSize: 11, color: "#6b6a70", lineHeight: 1.5, margin: "18px 0 0" } },
                "Hanya ilustrasi. Penghasilan aktual tergantung aktivitas dan ukuran akun trader."
              )
            )
          ),
  ...
  function Steps() {
    const steps = [
      ...
      { n: "03", chip: "Promotion",       title: "Bawa trader",
        body: "Share your link on socials, Telegram channels, YouTube, blogs or personal recommendations." },
      { n: "04", chip: "Penghasilan",             title: "Terima pembayaran",
        body: "Dapatkan hingga 80% of Hash Hedge profit for referred traders. Payouts in USDT within 72 hours." }
    ];
              ...
              _e("div", { className: "hh-cab-top-right", style: { display: "flex", alignItems: "center", gap: 10 } },
                _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10, padding: "6px 12px", border: "1px solid rgba(74,222,128,0.4)", borderRadius: 100, background: "rgba(8,8,10,0.5)" } },
                  ...
                  _e("div", { style: { lineHeight: 1.2 } },
                    ...
                    _e("div", { style: { fontSize: 10, color: "#a1a0a4" } }, "Manager pribadi Anda")
                  )
                ),
        ...
        _e(Reveal, { delay: "3" },
          _e("div", { className: "hh-cab-explainers", style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 } },
            [
              ...
              { paths: ["M22 11.08V12a10 10 0 1 1-5.93-9.14", "M22 4L12 14.01l-3-3"], t: "Sub-affiliate statistics", b: "Track komisi from all levels: your direct partners and their referrals." },
  ...
  function PartnerContent() {
    ...
    const videos = [
      ...
      { id: "oz_72s2S5Xc", title: "Platform & tertinggi breakdown",                                     author: "@cryptoschool",views: "41K"  },
  ...
  function Acara() {
    ...
    const events = [
      // [0] = hero big
      { flag: "🇦🇪", city: "Dubai",     year: "October 2025", role: "Penyelenggara", title: "WSCT Dubai · Live Tournament",     img: "https://hash-hedge-partner.vercel.app/assets/event-dubai.jpg" },
      // [1], [2] = stacked справа
      { flag: "🇷🇺", city: "Moskow",    year: "2025",          role: null,           title: "Mitra at Blockchain Forum",     img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/event-blockchain-forum.jpg" },
      { flag: "🇧🇷", city: "São Paulo", year: "2025",          role: "Penyelenggara", title: "WSCT Brazil · Live Tournament",   img: "https://hash-hedge-partner.vercel.app/assets/event-saopaulo.jpeg" },
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "Moskow",    year: "2026",          role: null,           title: "Pertemuan Afiliasi",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "Moskow",    year: "2026",          role: "Penyelenggara", title: "Penghargaan Top Afiliasi",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇷🇺", city: "Moskow",    year: "2026",          role: "Duta Hash Hedge", title: "Nikita Anufriev",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇷🇺", city: "Moskow",    year: "2026",          role: null,           title: "Pertemuan Afiliasi",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
    const Card = ({ ev, size }) => _e("div", {
      ...
      _e("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 45%, rgba(0,0,0,0.88) 100%)", pointerAcara: "none" } }),
  ...
  function TelegramCommunity() {
    ...
    const channelsBase = [
      ...
      { ic: "📣", name: "Mitra chat",   sub: "Друзья, всем привет! Напоминаем…",     time: "ПТ",     unread: 13 },
    ...
    const tgScenes = [
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Olga · Moskow: спасибо за промо-материалы, забрала 🤝",          time: "сейчас",  unread: 3 } } }
    ];
    ...
    return _e("section", { id: "telegram", "data-no-glow": true,
      ...
      _e("div", { "aria-hidden": true, className: "glow", style: {
        ...
        filter: "blur(120px)", opacity: 0.07, pointerAcara: "none", zIndex: 0
      } }),
      _e("style", null, `
            ...
            _e("div", { ref: tgRef, style: { maxWidth: 380, margin: "0 auto", position: "relative", opacity: 1 } },
              _e("div", {
                ...
                _e("div", { style: { background: "#0e0e10", borderRadius: 40, overflow: "hidden", position: "relative" } },
                  ...
                  // Затем в активном канале «Mitra chat» по сценарию меняется sub/badge — имитация переписки.
        ...
        _e("div", { className: "hh-support-grid", style: {
          ...
          _e(Reveal, null,
            _e("div", { style: {
              ...
              _e("img", { src: SUP_BASE + "assets/tati.jpg", alt: "Tati — Kepala Afiliasi",
              ...
              _e("div", { className: "hh-tati-badge", style: {
                ...
                _e("div", null,
                  ...
                  _e("div", { style: { fontSize: 12, color: "#cfcfd3", marginTop: 2 } }, "Kepala Afiliasi")
                ),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "Pertanyaan umum"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "Semua yang perlu Anda tahu tentang program afiliasi.")
          )
        ),
        _e(Reveal, { delay: "1" },
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 1 } },
        _e(Reveal, null,
          ...
          _e("div", {
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerAcara: "none", opacity: 0.6 } },
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerAcara: "none" } },
            ...
            _e("div", { "aria-hidden": true, style: {
              position: "absolute", inset: 0, pointerAcara: "none",
  ...
  function Footer() {
    const columns = [
      { t: "Produk", l: [
        { label: "Challenge",              href: "https://www.hashhedge.com/#challenge" },
        { label: "Program afiliasi",  href: "https://www.hashhedge.com/affiliateprogram" },
        { label: "Blog",                   href: "https://www.hashhedge.com/blog" },
        { label: "Panduan",            href: "https://hashhedge.gitbook.io/hashhedge-user-guide" }
      ]},
      { t: "Perusahaan", l: [
        { label: "Dukungan", href: "https://t.me/hashhedgesupportbot" },
        { label: "FAQ",       href: "https://www.hashhedge.com/faq" },
        { label: "Karier",  href: "https://www.hashhedge.com/vacancies" }
      ]},
      { t: "Hukum", l: [
        { label: "Privasi", href: "https://www.hashhedge.com/privacy-policy" },
        { label: "Syarat",       href: "https://www.hashhedge.com/terms-and-conditions" },
        { label: "Syarat komersial",        href: "https://www.hashhedge.com/commercial-terms" },
        { label: "Kebijakan partner",        href: "https://www.hashhedge.com/affiliate-politics" }
      ]}
    ];
    const partners = [
    ...
    return _e("footer", { style: { padding: "88px 0 64px", background: "var(--bg-elev)", borderTop: "1px solid var(--line)" } },
      _e("div", { className: "container", style: { maxWidth: 1180 } },
        ...
        _e("div", { style: { textAlign: "center" } },
          _e("div", { style: { fontSize: 16, color: "rgba(238,238,243,0.86)", marginBottom: 34 } }, "© 2026 HashHedge. Semua hak dilindungi."),
  ...
  if (!document.getElementById("hh-partner-styles")) {
    ...
    st.textContent = `
      ...
      /* v12.11 — ссылка «Hitung penghasilan»: белое подчёркивание + hover-анимация */
      ...
      /* v12.11 — фото Tati: быстрый hover-zoom как у карточек Acara langsung */
      ...
      @media (max-width: 980px) {
        ...
        /* v11.0 Acara: на планшете top→1кол, bottom→2кол */
      ...
      @media (max-width: 640px) {
        ...
        /* === v10.2 mobile: Acara — 1 hero + horizontal slider === */
        .hh-events-grid {
          display: flex !important;
          grid-template-columns: none !important;
          overflow-x: auto !important;
        ...
        /* === (v3.7 #5) Calculator: тексты одного размера, блок «Tier Anda» компактнее === */
        ...
        /* Компактный блок «Tier Anda · авто» */
        ...
        /* Acara — все 4 карточки одного размера + единый title 18px */
      ...
      @media (max-width: 980px) {
        ...
        /* (4) Acara — big card компактнее + горизонтальный слайдер остального */
