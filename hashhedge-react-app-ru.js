...
function HowItWorks() {
  ...
  const steps = [{
    ...
    d: "Реализуй свою трейдинговую стратегию на капитале до $150К и выводи до 90% прибыли.",
  ...
  }, "Получи капитал до $150К от Hash Hedge, торгуй свою стратегию и забирай до 90% прибыли."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
...
function Reviews() {
  ...
  const reviews = [{
    ...
    country: "Канада",
    size: "$50,000",
    quote: "Сначала не был уверен — компания ещё молодая. Но честно: условия торговли ровно такие, как заявлено. Я торгую вокруг крупных новостей, и здесь не было ни одного нарушенного правила, ни сильного проскальзывания. Платформа работает очень плавно, лимитные ордера исполняются идеально. Наконец-то проп-фирма, где можно просто торговать без стресса от скрытых ограничений.",
    days: "Апрель 2026",
    stars: 5
  }, {
    name: "Sultan A.",
    country: "ОАЭ",
    size: "$25,000",
    quote: "Сдал вчера экзамен на 25K. Терминал наконец не лагает, графики грузятся очень быстро. Никаких странных скрытых правил по просадке, как у других — всё прозрачно и понятно. Поддержка ответила за 5 минут, когда спросил про KYC. Пока всё отлично.",
    days: "Апрель 2026",
    stars: 5
  }, {
    name: "James C.",
    ...
    size: "$50,000",
    quote: "Торгую с Hash Hedge около двух месяцев и только что прошёл челлендж на $50,000. Больше всего ценю прозрачность. У многих проп-фирм скрытые правила по просадке, которые застают врасплох — здесь всё прописано открыто и понятно. Терминал очень отзывчивый даже на высоковолатильных новостях. Торговые условия — на высоком уровне.",
    days: "Апрель 2026",
    stars: 5
  }, {
    name: "Donna J.",
    country: "США",
    size: "$50,000",
    quote: "Перешла на Hash Hedge прежде всего из-за условий крипто-торговли. Процесс выплат прямой — никаких лишних препятствий, если соблюдаешь правила по просадке. Ограничения на ботов и API поначалу были непривычны, но это понятно — ради честной торговой среды. Для мануального трейдера, ищущего стабильность, работает отлично.",
    days: "Март 2026",
    stars: 5
  }, {
    name: "Marissa T.",
    ...
    country: "Грузия",
    size: "$25,000",
    quote: "Пришёл сюда в основном ради торговли криптой в выходные. Круто, что не блокируют аккаунт по субботам, как это делают другие. Терминал работает нормально, иногда графики на секунду подтормаживают при быстром переключении между мемкоинами. В целом — достойная проп-фирма, серьёзных претензий пока нет.",
    days: "Апрель 2026",
    stars: 4
  }, {
    name: "Дмитрий",
    country: "Россия",
    size: "$50,000",
    quote: "Hash Hedge по-настоящему задал новый стандарт для крипто-пропа. Прозрачность освежает — никаких скрытых условий или сюрпризов. Бонусы и акции разнообразные: от приветственных предложений до торговых конкурсов. Поддержка быстрая, компетентная и действительно полезная. Полностью заслуженные 5 звёзд.",
    days: "Ноябрь 2025",
    stars: 5
  }];
  return /*#__PURE__*/React.createElement("section", {
