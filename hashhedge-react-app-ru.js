...
function Reviews() {
  ...
  const reviews = [{
    ...
    country: "ОАЭ",
    size: "$25,000",
    quote: "Сдал вчера экзамен на 25K. Терминал наконец не лагает, графики грузятся очень быстро. Никаких странных скрытых правил по дродауну, как у других — всё прозрачно и понятно. Поддержка ответила за 5 минут, когда спросил про KYC. Пока всё отлично.",
    days: "Апрель 2026",
    stars: 5
  }, {
    name: "James C.",
    ...
    size: "$50,000",
    quote: "Торгую с Hash Hedge около двух месяцев и только что прошёл челлендж на $50,000. Больше всего ценю прозрачность. У многих проп-фирм скрытые правила по дродауну, которые застают врасплох — здесь всё опубликовано открыто и чётко. Терминал очень отзывчивый даже на высоковолатильных новостях. Торговый опыт — высший уровень.",
    days: "Апрель 2026",
    stars: 5
  }, {
    name: "Donna J.",
    ...
    country: "США",
    size: "$25,000",
    quote: "Терминал работает быстро, никаких скрытых правил, которые могут тебя запутать. В целом — хорошая фирма для торговли. Именно то, что я искала.",
    days: "Март 2026",
    stars: 5
  }, {
    name: "Dolores F. C.",
    country: "США",
    size: "$100,000",
    quote: "Удивительно стабильное исполнение на BTC/USD. Боялась слиппажа после старых отзывов, но мои лимитные ордера попадают ровно туда, куда нужно. Лаг дашборда пофиксили. Хорошая работа по техническому обновлению.",
    days: "Март 2026",
    stars: 5
  }, {
    name: "Axton K.",
    country: "Грузия",
    size: "$25,000",
    quote: "Пришёл сюда в основном ради торговли криптой в выходные. Круто, что не блокируют аккаунт по субботам, как это делают другие. Терминал работает нормально, иногда графики на секунду подтормаживают при быстром переключении между мемкоинами. В целом — достойный проп, реальных жалоб пока нет.",
    days: "Апрель 2026",
    stars: 4
  }, {
    name: "Дмитрий",
    country: "Россия",
    size: "$50,000",
    quote: "HashHedge по-настоящему задал новый стандарт для крипто-проп. Прозрачность освежает — никаких скрытых условий или сюрпризов. Промо щедрые и разнообразные: от приветственных бонусов до торговых конкурсов. Поддержка быстрая, компетентная и реально полезная. Настоятельно рекомендую. Заслуженные 5 звёзд!",
    days: "Ноябрь 2025",
    stars: 5
  }];
  return /*#__PURE__*/React.createElement("section", {
