...
function Pricing() {
  ...
  const [phase, setPhase] = ___useS(promoActive ? 1 : 2);          // 1 etapa padrão (novo); 2 = 2-fases
  ...
  const paymentLinks2 = {
    ...
    50000: "https://app.hashhedge.com/pt/app/payment-form/9b66fb15-a4ff-4eb3-b61f-694b0828a70b",
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Duas fases para se qualificar. Seis tamanhos de conta. As mesmas regras do início ao fim: sem regra de consistência e sem resets escondidos."))), /*#__PURE__*/React.createElement(Reveal, {
    delay: "2"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 1112,
    ...
    }, isBest ? "Melhor valor" : "Popular"), /*#__PURE__*/React.createElement("div", {
...
function TeamCerts() {
  ...
  // Original 8
  {
    ...
    name: "Leon Caquipanov",
    amount: "407.12",
    acc: "$5,000",
    date: "07 Aug 2025",
    src: (window.__HH_BASE__+"img/cert-caquipanov.png")
  },
...
function Footer() {
  ...
  }, "\xA9 2026 HashHedge. Todos os direitos reservados."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 12,
      lineHeight: 1.35,
...
@media (max-width: 600px) {
  ...
  var node = React.createElement("div", {
    ...
    React.createElement("div", { className: "hh1-popup-modal" },
      ...
      React.createElement("p", { className: "hh1-popup-disclaimer" }, 'Promoção válida até 13 de junho de 2026, 15:00 (horário de Dubai). Após o término do cronômetro, o acesso ao desafio de 1 etapa será fechado automaticamente.')
    )
  );
