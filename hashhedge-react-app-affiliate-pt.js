(function(){
  ...
  function Header() {
    ...
    const langs = [
      ...
      { code: "PT", flag: "🇧🇷", label: "Português",        href: "#", current: true },
  ...
  function Hero() {
    ...
    // matrix-стене), большой H1 в 4 строки с акцентом на «ganhe junto», 2 CTA,
    // ссылка «Calcule seus ganhos», блок Trustpilot снизу с 4-stat ряду.
    ...
    return _e("section", {
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 2 } },
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            ...
            _e("h1", { className: "hh-partner-hero-h1",
              ...
              "Promova uma firma prop", _e("br", null),
              "cripto de topo", _e("br", null),
              "no mundo todo e", _e("br", null),
              _e("span", { style: { color: "#fcd535" } }, "ganhe junto")
            ),
            _e("p", { className: "hh-partner-hero-sub", style: {
              ...
              " por cada trader que indicar — pagamentos semanais em USDT, vitalício."
            ),
        ...
        _e("div", { className: "hh-partner-hero-stats", style: {
          ...
          _e("div", null,
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 8, whiteSpace: "nowrap" } }, "Parceria com uma plataforma confiável"),
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Traders financiados no mundo")
          ),
          // $12M+
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Pago a traders")
          ),
          // 4.4/5
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
  ...
  function AboutProgram() {
    const cards = [
      { v: "até 80%", t: "do lucro da HashHedge",         b: "A maior comissão do mercado por cada trader indicado." },
      { v: "Semanal", t: "pagamentos em USDT",            b: "Seus ganhos chegam à sua carteira toda segunda-feira." },
      { v: "Vitalício", t: "comissões",                 b: "Você ganha enquanto o trader permanecer ativo." },
      { v: "Minutos", t: "para ser aprovado",                   b: "Aprovação rápida, formalidades mínimas, link instantâneo." }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "As melhores condições", _e("br", null),
                "de afiliação ", _e("span", { style: { color: "#fcd535" } }, "do mercado.")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "A HashHedge dá aos traders cripto ", _e("strong", { style: { color: "#f5f1e8" } }, "$5,000 to $100,000"),
              " para operarem sem risco. Seu trabalho é simples — traga esses traders. Em troca, você recebe uma parte da receita que eles geram, nas condições mais generosas que uma firma prop oferece."
            )
          )
        ),
          ...
          cards.map((c, i) => _e(Reveal, { key: i, delay: String((i % 4) + 1) },
            _e("div", { className: "hh-about-card", style: {
              ...
              _e("div", { style: {
                ...
                marginBottom: 12,
                fontFamily: "Onest, sans-serif",
                textTransform: c.v === "até 80%" || c.v === "Minutos" || c.v === "Vitalício" || c.v === "Semanal" ? "none" : "uppercase"
              } }, c.v),
  ...
  function WhyPartner() {
    ...
    const V1 = () => isMobile
      ? _e("div", { className: "hh-v1 hh-v1-mobile", style: { width: "100%", textAlign: "center", padding: "0 4px", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" } },
          _e("div", { style: { fontSize: 38, fontWeight: 900, color: "#fcd535", lineHeight: 1, letterSpacing: "-0.03em" } }, "até 80%"),
    ...
    // V9 — Rede multinível. Картинка увеличена (viewBox шире), круги с непрозрачным фоном.
    const V9 = () => _e("div", { style: { width: "100%", padding: 0, position: "relative" } },
      _e("svg", { width: "100%", height: 180, viewBox: "0 0 220 130", style: { display: "block" } },
        ...
        _e("text", { x: 110, y: 33, textAnchor: "middle", style: { fontSize: 11, fontWeight: 800, fill: "#13111c" } }, "VOCÊ"),
    ...
    const cards = [
      { viz: _e(V1, null), chip: "Top in the prop industry", title: "Até 80% do lucro Hash Hedge", titleAccent: "before",
      ...
      { viz: _e(V2, null), chip: "One trader = lifetime income", title: "Comissões vitalícias", titleAccent: "before",
        body: "Every trader is locked to you for life. You earn from every single purchase they make." },
      { viz: _e(V3, null), chip: "Better than exchange offers", title: "Mais lucro que em exchanges",
        body: "One funded trader with a $25–50K account brings in 5–10× more than a standard exchange referral." },
      { viz: _e(V4, null), chip: "Withdrawals within 72 hours", title: "Pagamentos rápidos", titleAccent: "before",
        body: "Request a USDT withdrawal any time. Funds reach your wallet within 72 hours." },
      { viz: _e(V5, null), chip: "Grow automatically", title: "7 níveis de parceiro", titleAccent: "before",
      ...
      // === 3 новые карточки ===
      { viz: _e(V7, null), chip: "Discounts for your audience", title: "Cupons para sua audiência", titleAccent: "before",
        body: "Get personal discounts for your audience to boost conversion and drive purchases through your link." },
      { viz: _e(V8, null), chip: "Traffic analytics", title: "Tracking flexível",
        body: "Build custom links to segment traffic and track conversions in your partner dashboard." },
      { viz: _e(V9, null), chip: "Rede multinível", title: "Programa subafiliado",
  ...
  function IncomeSources() {
    ...
    const sources = [
      { n: "01", title: "Comissão por vendas",
        body: _e(F, null, "Earn ", _e("b", { style: { color: "#fcd535" } }, "até 80%"), " of Hash Hedge profit on every purchase. Referrals are locked to you for life: bring them in once, earn from every future purchase."),
        pill: "Renda recorrente",
      ...
      { n: "03", title: "Programa subafiliado",
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 760, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Seu link de afiliado pode gerar renda de três fontes ao mesmo tempo.")
          )
        ),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 880, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Atraia traders and take até 80% of Hash Hedge profit.")
          )
        ),
        ...
        _e("div", { className: "hh-bp-wrap", style: {
            ...
            _e("div", { className: "hh-bp-track-inner", style: {
              ...
              tiers.map((t, i) => {
                ...
                return _e("button", { key: t.lvl, type: "button",
                  ...
                  "aria-label": `Nível ${t.lvl} ${t.label}, комиссия ${t.pct}%`,
                  style: {
          ...
          } }, "Clique em qualquer nível →  veja detalhes")
        ),
        ...
        _e("div", { style: { textAlign: "center", fontSize: 13, color: "#a1a0a4" } },
          "Nível recalculates automatically each month based on the number of active referred traders"
        )
      )
    );
  }
      ...
      _e("div", { className: "container" },
          ...
          _e("div", { className: "hh-calc-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { className: "hh-calc-h2", style: { fontSize: "clamp(32px, 4vw, 48px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Quanto mais trouxer,", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "maior sua comissão.")
              )
            ),
        ...
        _e("div", { className: "hh-calc-grid", style: {
          ...
          _e("div", { className: "hh-calc-card", style: {
            ...
            _e("div", { style: { fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a7a80", marginBottom: 24 } }, "Calculadora de ganhos"),
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 } },
              _e("div", { style: { fontSize: 14, color: "#a1a0a4" } }, "Traders indicados ativos"),
            ...
            _e("div", { style: { display: "flex", gap: 12, marginTop: 28 } },
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Seu nível"),
                _e("div", { style: { fontSize: 26, fontWeight: 800, color: "#fcd535", lineHeight: 1, fontFamily: "Onest, sans-serif" } }, currentTier.pct + "%"),
                _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Nível " + currentTier.lvl)
              ),
              _e("div", { style: {
                flex: 1,
                padding: "16px 18px",
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Média / trader / mês"),
            ...
            _e("div", { style: { marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--line)" } },
              _e("div", { style: { fontSize: 13, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 } }, "Pagamento mensal estimado"),
              ...
              _e("p", { style: { fontSize: 11, color: "#6b6a70", lineHeight: 1.5, margin: "18px 0 0" } },
                "Apenas ilustrativo. Ganhos reais dependem da atividade do trader e do tamanho das contas."
              )
            )
          ),
            ...
            tiers.map(t => {
              ...
              return _e("button", { key: t.lvl, type: "button",
                ...
                _e("div", { style: { flex: 1, minWidth: 0, marginLeft: 16, position: "relative", zIndex: 1 } },
                  _e("div", { className: "hh-calc-tier-name", style: { fontSize: 13, fontWeight: 700, color: "#a1a0a4" } }, "Nível " + t.lvl),
  ...
  function Steps() {
    const steps = [
      { n: "01", chip: "Cadastre-se",       title: "Cadastro",
      ...
      { n: "03", chip: "Promotion",       title: "Atraia traders",
        body: "Share your link on socials, Telegram channels, YouTube, blogs or personal recommendations." },
      { n: "04", chip: "Ganhos",             title: "Receba pagamento",
        body: "Receba até 80% of Hash Hedge profit for referred traders. Payouts in USDT within 72 hours." }
    ];
              ...
              _e("div", { className: "hh-cab-top-right", style: { display: "flex", alignItems: "center", gap: 10 } },
                _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10, padding: "6px 12px", border: "1px solid rgba(74,222,128,0.4)", borderRadius: 100, background: "rgba(8,8,10,0.5)" } },
                  ...
                  _e("div", { style: { lineHeight: 1.2 } },
                    ...
                    _e("div", { style: { fontSize: 10, color: "#a1a0a4" } }, "Seu manager pessoal")
                  )
                ),
        ...
        _e(Reveal, { delay: "3" },
          _e("div", { className: "hh-cab-explainers", style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 } },
            [
              ...
              { paths: ["M22 11.08V12a10 10 0 1 1-5.93-9.14", "M22 4L12 14.01l-3-3"], t: "Sub-affiliate statistics", b: "Track comissões from all levels: your direct partners and their referrals." },
  ...
  function PartnerContent() {
    ...
    const videos = [
      ...
      { id: "oz_72s2S5Xc", title: "Platform & de afiliação breakdown",                                     author: "@cryptoschool",views: "41K"  },
  ...
  function Eventos() {
    ...
    const events = [
      ...
      // [1], [2] = stacked справа
      { flag: "🇷🇺", city: "Moscou",    year: "2025",          role: null,           title: "Parceiros at Blockchain Forum",     img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/event-blockchain-forum.jpg" },
      ...
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: null,           title: "Encontro de afiliados",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: "Organizador", title: "Top Affiliate Awards",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: "Embaixador Hash Hedge", title: "Nikita Anufriev",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: null,           title: "Encontro de afiliados",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
  ...
  function TelegramCommunity() {
    ...
    const channelsBase = [
      ...
      { ic: "📣", name: "Parceiros chat",   sub: "Друзья, всем привет! Напоминаем…",     time: "ПТ",     unread: 13 },
    ...
    const tgScenes = [
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Максим · Алматы 🇰🇿: только что прошёл Nível 3 🔥",              time: "сейчас",  unread: 1 } } },
            ...
            _e("div", { ref: tgRef, style: { maxWidth: 380, margin: "0 auto", position: "relative", opacity: 1 } },
              _e("div", {
                ...
                _e("div", { style: { background: "#0e0e10", borderRadius: 40, overflow: "hidden", position: "relative" } },
                  ...
                  // Затем в активном канале «Parceiros chat» по сценарию меняется sub/badge — имитация переписки.
        ...
        _e("div", { className: "hh-support-grid", style: {
          ...
          _e(Reveal, null,
            _e("div", { style: {
              ...
              _e("img", { src: SUP_BASE + "assets/tati.jpg", alt: "Tati — Head de Afiliados",
              ...
              _e("div", { className: "hh-tati-badge", style: {
                ...
                _e("div", null,
                  ...
                  _e("div", { style: { fontSize: 12, color: "#cfcfd3", marginTop: 2 } }, "Head de Afiliados")
                ),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "Perguntas frequentes"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "Tudo o que você precisa saber sobre o programa.")
          )
        ),
        _e(Reveal, { delay: "1" },
  ...
  function Footer() {
    const columns = [
      { t: "Produto", l: [
        ...
        { label: "Guia do usuário",            href: "https://hashhedge.gitbook.io/hashhedge-user-guide" }
      ]},
      { t: "Empresa", l: [
        { label: "Suporte", href: "https://t.me/hashhedgesupportbot" },
        { label: "FAQ",       href: "https://www.hashhedge.com/faq" },
        { label: "Carreiras",  href: "https://www.hashhedge.com/vacancies" }
      ]},
      { t: "Legal", l: [
        { label: "Privacidade", href: "https://www.hashhedge.com/privacy-policy" },
        { label: "Termos",       href: "https://www.hashhedge.com/terms-and-conditions" },
        { label: "Termos comerciais",        href: "https://www.hashhedge.com/commercial-terms" },
        { label: "Política do parceiro",        href: "https://www.hashhedge.com/affiliate-politics" }
      ]}
    ];
    const partners = [
    ...
    return _e("footer", { style: { padding: "88px 0 64px", background: "var(--bg-elev)", borderTop: "1px solid var(--line)" } },
      _e("div", { className: "container", style: { maxWidth: 1180 } },
        ...
        _e("div", { style: { textAlign: "center" } },
          _e("div", { style: { fontSize: 16, color: "rgba(238,238,243,0.86)", marginBottom: 34 } }, "© 2026 HashHedge. Todos os direitos reservados."),
  ...
  if (!document.getElementById("hh-partner-styles")) {
    ...
    st.textContent = `
      ...
      /* v12.11 — ссылка «Calcule seus ganhos»: белое подчёркивание + hover-анимация */
      ...
      /* v12.11 — фото Tati: быстрый hover-zoom как у карточек Eventos ao vivo */
      ...
      @media (max-width: 640px) {
        ...
        /* === (v3.7 #5) Calculator: тексты одного размера, блок «Seu nível» компактнее === */
        ...
        /* Компактный блок «Seu nível · авто» */
