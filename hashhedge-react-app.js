...
function Hero({
  ...
  }, `${_hhTraders().toLocaleString()} funded traders`))), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 32,
      width: 1,
      background: "var(--line)"
...
function HowItWorks() {
  ...
  const steps = [{
    ...
    bullets: ["Two-stage: 2 verification stages", "One-stage: 1 verification stage", "Clear profit targets and loss limits"]
  }, {
    n: "03",
    k: "GET FUNDED",
...
const PRICING_TOOLTIPS_EN = {
  ...
  "Max Drawdown": "Total account loss limit during the stage",
...
function Pricing() {
  useRevealOnScroll();
  // 1-phase challenge promo: 29.06.2026 23:00 MSK → 01.07.2026 23:59 Dubai time.
  ...
  // Flash Sale 25%: 30 Jul 2026 00:00 Dubai (UTC+4) → 31 Jul 2026 23:59 Dubai. Active only via ?fs=force (FS_AUTO=false). Promo FLASH25, $100K/$150K/$200K (2-phase).
  ...
  const [phase, setPhase] = ___useS(fsActive ? 2 : (promoActive ? 1 : 2));          // 1-phase default (new); 2 = 2-phase
  ...
  const paymentLinks2 = {
    5000: "https://app.hashhedge.com/en/app/payment-form/f9b2dbd5-3026-417e-a499-e5b8f68c9a21",
    10000: "https://app.hashhedge.com/en/app/payment-form/a19ac1b9-4c6d-4ec1-ba10-9654c084bf75",
    25000: "https://app.hashhedge.com/en/app/payment-form/ef17553b-ecf4-434e-aec6-594b8a8dd002",
    50000: "https://app.hashhedge.com/en/app/payment-form/57c31474-1b94-41ac-8f8b-87bcacc17701",
    100000: "https://app.hashhedge.com/en/app/payment-form/2cac9366-8647-4f17-b597-0585761c2e00",
    150000: "https://app.hashhedge.com/en/app/payment-form/63503f96-96e3-4eb6-b339-d41af3acaac7",
  ...
  const accountNotes2 = {
    ...
    200000: "$200K capital for the most ambitious strategies."
  };

  // ── 1-PHASE DATA (new challenge) ───────────────────────────────────────────
  ...
  // 1-phase payment-form URLs (live).
  const paymentLinks1 = {
    5000: "https://app.hashhedge.com/en/app/payment-form/b99716c0-8e0d-4d1f-9853-127b962ca1bb",
    10000: "https://app.hashhedge.com/en/app/payment-form/d3e600cd-5677-417f-aa71-39dbeda39e3b",
    25000: "https://app.hashhedge.com/en/app/payment-form/2ed6981a-9fef-4fcc-bd88-2d40e98f46ce",
    50000: "https://app.hashhedge.com/en/app/payment-form/e66eab0a-a018-4483-ae7d-bac1d951d314",
    100000: "https://app.hashhedge.com/en/app/payment-form/383c866d-8b20-426d-8638-5ae74a33e4d9"
  };
  const accountNotes1 = {
    5000: "Starter 1-stage account for a fast first funded.",
    10000: "Compact 1-stage account with the lowest drawdown.",
    25000: "Sweet spot for traders with disciplined risk management.",
    50000: "Larger 1-stage account for confident trading.",
    100000: "New maximum 1-stage account — more capital in one stage."
  };

  // ── Active dataset (selected by phase) ─────────────────────────────────────
  ...
  // Defensive: if size/mobileStage become invalid after phase switch — soft fallback
  React.useEffect(() => {
  ...
  const mobileStageRules1 = {
    stage1: [["Profit Target", "10%"], ["Max Daily Loss", "3%"], ["Max Drawdown", "6%"], ["Min Trading Days", "5 days"], ["Trading Period", "Unlimited"], ["Leverage", "1:5"]],
    funded: [["Profit Target", "No target"], ["Max Daily Loss", "3%"], ["Max Drawdown", "6%"], ["Min Trading Days", "-"], ["Trading Period", "Unlimited"], ["Leverage", "1:5"], ["Profit Split", "90%"], ["Payouts", "USDT to wallet"]]
  };
  ...
  // Defensive: if size disappears from current set between render and useEffect fallback — use pricing[popular]
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Two stages to qualify. Six account sizes. Same rules end-to-end: no consistency rule, no hidden resets."))), /*#__PURE__*/React.createElement(Reveal, {
    delay: "2"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 1112,
  ...
  }, "1-Stage Challenge", /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      padding: "2px 7px",
  ...
  }, "2-Stage Challenge")))), /*#__PURE__*/React.createElement(Reveal, {
    delay: "3"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 1112,
    ...
    const badge = isNewOne ? "NEW" : isFlash ? "Flash Sale" : isBest ? "BEST VALUE" : isPop ? "POPULAR" : null;
    ...
    }, isNewOne ? "New" : isFlash ? "Flash Sale" : isBest ? "Best value" : "Popular"), /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("span", null, "One-time Challenge fee"), /*#__PURE__*/React.createElement("b", null, isFlash ? renderFSPrice(pricing[s]) : React.createElement(React.Fragment, null, "$", pricing[s]))), /*#__PURE__*/React.createElement("p", null, accountNotes[s]), /*#__PURE__*/React.createElement("div", {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "One-time fee"), /*#__PURE__*/React.createElement("b", null, sizeIsFlash ? renderFSPrice(price) : React.createElement(React.Fragment, null, "$", price)))), /*#__PURE__*/React.createElement("p", null, accountNotes[size]), /*#__PURE__*/React.createElement("div", {
    ...
    /*#__PURE__*/React.createElement("div", { key: "dd" }, /*#__PURE__*/React.createElement("span", null, "Daily loss"), /*#__PURE__*/React.createElement("b", null, "3%")),
    ...
    /*#__PURE__*/React.createElement("div", { key: "min" }, /*#__PURE__*/React.createElement("span", null, "Min days"), /*#__PURE__*/React.createElement("b", null, "5")),
    /*#__PURE__*/React.createElement("div", { key: "term" }, /*#__PURE__*/React.createElement("span", null, "Period"), /*#__PURE__*/React.createElement("b", null, "Unlimited"))
  ] : [
    ...
    /*#__PURE__*/React.createElement("div", { key: "dd" }, /*#__PURE__*/React.createElement("span", null, "Daily loss"), /*#__PURE__*/React.createElement("b", null, "5%")),
    ...
    /*#__PURE__*/React.createElement("div", { key: "min" }, /*#__PURE__*/React.createElement("span", null, "Min days"), /*#__PURE__*/React.createElement("b", null, "5 + 5")),
    /*#__PURE__*/React.createElement("div", { key: "term" }, /*#__PURE__*/React.createElement("span", null, "Period"), /*#__PURE__*/React.createElement("b", null, "Unlimited"))
  ]), /*#__PURE__*/React.createElement("a", {
...
function Reviews() {
  ...
  }, `${_hhTraders().toLocaleString()} funded traders.`, /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--accent)"
    }
...
function PromoPopup() {
  ...
  var cards = [
    { acc: "$100K", orig: "$799", sale: "$599.25", href: "https://app.hashhedge.com/en/app/payment-form/2cac9366-8647-4f17-b597-0585761c2e00" },
    { acc: "$150K", orig: "$1,093", sale: "$819.75", href: "https://app.hashhedge.com/en/app/payment-form/63503f96-96e3-4eb6-b339-d41af3acaac7" },
    { acc: "$200K", orig: "$1,293", sale: "$969.75", href: "https://app.hashhedge.com/en/app/payment-form/982b97fd-4431-456e-99b0-7dfb1ec4d68b" }
  ];
    ...
    /*#__PURE__*/React.createElement("div", {
      ...
      /*#__PURE__*/React.createElement("div", {className:"hh-popup-copy", style:{maxWidth:"none", textAlign:"center"}},
        ...
        /*#__PURE__*/React.createElement("h2", {className:"hh-popup-title", style:{textAlign:"center"}},
          "25% OFF", /*#__PURE__*/React.createElement("br", null), "Hash Hedge Challenges"
        ),
        ...
        /*#__PURE__*/React.createElement("div", {className:"hh-fs-cards"},
          cards.map(c => /*#__PURE__*/React.createElement("a", {
            ...
            /*#__PURE__*/React.createElement("div", {className:"hh-fs-card-left"},
              /*#__PURE__*/React.createElement("span", {className:"hh-fs-card-label"}, "Account Size"),
            ...
            /*#__PURE__*/React.createElement("span", {className:"hh-fs-card-btn-text"}, "Buy Now")
          ))
        ),
...
@media (max-width: 480px) {
  ...
  .hh1-popup-card-btn-v2::after { content: "Buy"; font-size: 12px; }
  ...
  var promoEl = React.createElement("div", { onClick: copyCode, style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, cursor: "pointer", background: "rgba(252,213,53,0.08)", border: "1px solid rgba(252,213,53,0.5)", borderRadius: 16, padding: "11px 16px" } }, React.createElement("span", { style: { fontSize: 14, fontWeight: 700, color: "rgba(245,241,232,0.8)" } }, "Promo Code"), React.createElement("span", { style: { display: "inline-flex", alignItems: "center", gap: 8, background: "#fcd535", color: "#13111c", fontWeight: 900, fontSize: 18, letterSpacing: "0.08em", borderRadius: 10, padding: "6px 14px" } }, "FREE90", React.createElement("svg", { width: 15, height: 15, viewBox: "0 0 24 24", fill: "none", style: { color: copied ? "#1a7a1a" : "#13111c" } }, copyIcon)));
  var timerEl = React.createElement("div", { style: { marginBottom: 18 } }, React.createElement("span", { style: { display: "block", fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "rgba(245,241,232,0.6)", marginBottom: 8 } }, "Offer is limited"), React.createElement("div", { style: { display: "inline-flex", gap: 6 } }, tbox(time.h), tcolon(), tbox(time.m), tcolon(), tbox(time.s)));
  var buyEl = React.createElement("a", { href: "https://app.hashhedge.com/en/app/start-challenge", target: "_blank", rel: "noopener", onClick: close, style: { display: "block", textAlign: "center", background: "#fcd535", color: "#13111c", fontWeight: 800, fontSize: 16, borderRadius: 12, padding: "14px 24px", textDecoration: "none" } }, "Buy Challenge");
  var stack = React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 10, marginTop: 2 } }, feature("Auto Daily Loss Reset"), feature("+10% profit split"), promoEl, buyEl);
  ...
  var badgeEl = React.createElement("span", { style: { display: "inline-block", background: "#fcd535", color: "#13111c", fontWeight: 800, fontSize: 13, borderRadius: 100, padding: "6px 16px", marginBottom: 14 } }, "Today — Free");
  var titleEl = React.createElement("h2", { className: "hh1-popup-title", style: { marginBottom: 10 } }, "90/10 Profit Split and Daily Loss Protection");
  var capEl = React.createElement("p", { style: { fontSize: 14.5, color: "rgba(245,241,232,0.7)", lineHeight: 1.45, margin: "0 0 18px" } }, "Valid for challenges from $25K");
