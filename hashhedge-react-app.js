...
function PayoutShowcase() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/payout-certificate.png")),
    alt: "Real HashHedge payout certificate",
    style: {
      display: "block",
      width: "100%",
...
function EventsTournaments() {
  ...
  const featured = {
    ...
    blurb: "Hash Hedge crowning the WSCT Qualifying Tour Brazil winner – one of the four live qualifiers we ran across LATAM last year.",
    img: (window.__HH_BASE__+(window.__HH_BASE__+"assets/team/event-headliner-yarik.webp"))
  };
  const events = [{
    city: "São Paulo",
    flag: "🇧🇷",
    ...
    role: "Host",
    date: "2025",
    img: (window.__HH_BASE__+(window.__HH_BASE__+"assets/team/event-bcl-dubai-stage.webp"))
  }, {
    city: "Dubai",
    flag: "🇦🇪",
    event: "Brand Ambassador on Main Stage",
    role: "Sponsor",
    date: "2025",
    img: (window.__HH_BASE__+(window.__HH_BASE__+"assets/team/event-wsct-booth.jpg"))
  }, {
    city: "Dubai",
    flag: "🇦🇪",
    event: "WSCT Dubai · Live Trading Floor",
    role: "Host",
    date: "Oct 2025",
    img: (window.__HH_BASE__+(window.__HH_BASE__+"assets/team/event-afterparty.jpg"))
  }, {
    city: "Moscow",
    flag: "🇷🇺",
    event: "Affiliates Meet-up",
    role: "Host",
    date: "2026",
    img: (window.__HH_BASE__+(window.__HH_BASE__+"assets/team/event-qualifier-winner.jpg"))
  }, {
    city: "São Paulo",
    flag: "🇧🇷",
    event: "Live Trading Showcase · WSCT Brazil",
    role: "Organizer",
    date: "2025",
    img: (window.__HH_BASE__+(window.__HH_BASE__+"assets/team/event-booth-screens.webp"))
  }, {
    city: "Moscow",
    flag: "🇷🇺",
    event: "Top Affiliate Awards 2026",
    role: "Host",
    date: "2026",
    img: (window.__HH_BASE__+(window.__HH_BASE__+"assets/team/awards-top-affiliate.jpg"))
  }];
  return /*#__PURE__*/React.createElement("section", {
    style: {
      padding: "100px 0",
...
function SupportSection() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/support-agent.png")),
    alt: "Sofia \u2013 Senior Support Lead",
    style: {
      position: "absolute",
      inset: 0,
  ...
  }), "Online \xB7 Replying now"), /*#__PURE__*/React.createElement("div", {
    style: {
      position: "absolute",
      top: 20,
      right: 20,
...
function TeamCerts() {
  ...
  // Original 8
  {
    ...
    acc: "$100,000",
    date: "07 Aug 2025",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-anikeev.png"))
  }, {
    name: "Aleksandr Popov",
    amount: "7,538.92",
    acc: "$100,000",
    date: "04 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-popov.jpg"))
  }, {
    name: "Ryan Sullivan",
    amount: "2,707.16",
    acc: "$50,000",
    date: "11 Aug 2025",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-sullivan.png"))
  }, {
    name: "Alex Okulov",
    amount: "2,446.78",
    acc: "$100,000",
    date: "07 Sep 2025",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-okulov.png"))
  }, {
    name: "Amir Senenov",
    amount: "1,304.68",
    acc: "$50,000",
    date: "17 Jul 2025",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-senenov.png"))
  }, {
    name: "Roman Dzhepparov",
    amount: "1,296.61",
    acc: "$5,000",
    date: "22 Jun 2025",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-dzhepparov.png"))
  }, {
    name: "Maxim Ognev",
    amount: "487.11",
    acc: "$5,000",
    date: "04 Sep 2025",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-ognev.png"))
  }, {
    name: "Leon Cherepanov",
    amount: "407.12",
    acc: "$5,000",
    date: "07 Aug 2025",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-cherepanov.png"))
  },
  // New 10 (real certificates)
  {
    name: "Alexey Morozov",
    ...
    acc: "$100,000",
    date: "14 Feb 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-morozov.jpeg"))
  }, {
    name: "Oskar Chmiel",
    amount: "3,621.09",
    acc: "$25,000",
    date: "13 Feb 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-chmiel.jpeg"))
  }, {
    name: "Onur Karaca",
    amount: "7,024.85",
    acc: "$100,000",
    date: "18 Feb 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-karaca.jpeg"))
  }, {
    name: "Pavel Zaitsev",
    amount: "8,927.11",
    acc: "$100,000",
    date: "17 Feb 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-zaitsev.jpeg"))
  }, {
    name: "Alexey Machkalyan",
    amount: "7,928.49",
    acc: "$100,000",
    date: "05 Feb 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-machkalyan.jpeg"))
  }, {
    name: "Rashad Aliyev",
    amount: "9,224.71",
    acc: "$100,000",
    date: "04 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-aliyev.jpeg"))
  }, {
    name: "Aleksandr Popov",
    amount: "7,538.92",
    acc: "$100,000",
    date: "04 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-popov2.jpeg"))
  }, {
    name: "Aleks Grachev",
    amount: "7,318.92",
    acc: "$100,000",
    date: "10 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-grachev.jpeg"))
  }, {
    name: "Pavel Shubin",
    amount: "5,290.17",
    acc: "$100,000",
    date: "09 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-shubin.jpeg"))
  }, {
    name: "Ilkin Jafarov",
    amount: "4,157.22",
    acc: "$50,000",
    date: "14 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-jafarov.jpeg"))
  },
  // Batch 3 – 14 more real certificates
  {
    name: "Timur Kulikov",
    ...
    acc: "$25,000",
    date: "14 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-kulikov.jpeg"))
  }, {
    name: "Aleksandr Kaplin",
    amount: "10,000.00",
    acc: "$100,000",
    date: "18 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-kaplin.jpeg"))
  }, {
    name: "Denis Huhlaev",
    amount: "9,820.52",
    acc: "$100,000",
    date: "16 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-huhlaev.jpeg"))
  }, {
    name: "Aband Eddy",
    amount: "6,475.88",
    acc: "$100,000",
    date: "16 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-eddy1.jpeg"))
  }, {
    name: "Olga Kovlenko",
    amount: "5,096.17",
    acc: "$100,000",
    date: "16 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-kovlenko.jpeg"))
  }, {
    name: "Jukeen Bande",
    amount: "8,622.65",
    acc: "$100,000",
    date: "20 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-bande.jpeg"))
  }, {
    name: "Vadym Vads",
    amount: "4,644.40",
    acc: "$50,000",
    date: "16 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-vads.jpeg"))
  }, {
    name: "Sergi Tolmachev",
    amount: "7,102.34",
    acc: "$100,000",
    date: "27 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-tolmachev.jpeg"))
  }, {
    name: "Aleksei Razenkov",
    amount: "6,422.47",
    acc: "$100,000",
    date: "25 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-razenkov.jpeg"))
  }, {
    name: "Irina Stuchevskaya",
    amount: "2,517.62",
    acc: "$50,000",
    date: "25 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-stuchevskaya.jpeg"))
  }, {
    name: "Olga Kuznetsova",
    amount: "2,404.64",
    acc: "$50,000",
    date: "28 Mar 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-kuznetsova.jpeg"))
  }, {
    name: "Nik Pechersky",
    amount: "10,000.00",
    acc: "$150,000",
    date: "07 Apr 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-pechersky.jpeg"))
  }, {
    name: "Elzatbek Berenaliev",
    amount: "10,000.00",
    acc: "$100,000",
    date: "07 Apr 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-berenaliev.jpeg"))
  }, {
    name: "Aband Eddy",
    amount: "7,712.92",
    acc: "$100,000",
    date: "01 Apr 2026",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"img/cert-eddy2.jpeg"))
  }];
...
function BigCTA() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "cta-coin usdt",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/crypto-usdt.svg")),
    alt: ""
  }), /*#__PURE__*/React.createElement("img", {
    className: "cta-coin btc",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/crypto-btc.svg")),
    alt: ""
  }), /*#__PURE__*/React.createElement("img", {
    className: "cta-coin eth",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/crypto-eth.svg")),
    alt: ""
  }), /*#__PURE__*/React.createElement("img", {
    className: "cta-coin usdc",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/crypto-usdc.svg")),
    alt: ""
  }), /*#__PURE__*/React.createElement("img", {
    className: "cta-coin sol",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/crypto-sol.svg")),
    alt: ""
  }), /*#__PURE__*/React.createElement("img", {
    className: "cta-coin xlm",
    src: (window.__HH_BASE__+(window.__HH_BASE__+"assets/crypto-stellar.svg")),
    alt: ""
  }), /*#__PURE__*/React.createElement("div", {
    className: "cta-spark",
    style: {
...
function Nav({
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    href: "#why"
  }, "Why us")), /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement("a", {
    href: "#press"
