...
function Pricing() {
  ...
  const [phase, setPhase] = ___useS(promoActive ? 1 : 2);          // 1-phase default (new); 2 = 2-phase
  ...
  const paymentLinks1 = {
    5000: "https://app.hashhedge.com/en/app/payment-form/f23e0213-0f1c-4901-9bcb-f33231fdf6fb",
    10000: "https://app.hashhedge.com/en/app/payment-form/817e214a-bca2-4320-a58c-c499d9313d2e",
    15000: "https://app.hashhedge.com/en/app/payment-form/09535d91-26d6-46cc-8752-091eb74ee44b",
    25000: "https://app.hashhedge.com/en/app/payment-form/23cc5222-49fc-4d30-9387-94ffc1e32450",
    30000: "https://app.hashhedge.com/en/app/payment-form/a78b583b-b93d-45da-808a-aa905104b475"
  };
  const accountNotes1 = {
    5000: "Starter 1-phase account for a fast first funded.",
    10000: "Compact 1-phase account with the lowest drawdown.",
    15000: "Sweet spot for traders with disciplined risk management.",
    25000: "Most popular 1-phase account.",
    30000: "Maximum 1-phase account — best fee per $1K of capital."
  };
  ...
  const flashSaleSizes = []; // promos disabled — mechanism kept for future campaigns
  ...
  }, "1-Phase Challenge", /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      padding: "2px 7px",
...
@media (max-width: 600px) {
  ...
  var cards = [
    { acc: "$5,000", price: "$99", href: "https://app.hashhedge.com/en/app/payment-form/f23e0213-0f1c-4901-9bcb-f33231fdf6fb" },
    { acc: "$10,000", price: "$159", href: "https://app.hashhedge.com/en/app/payment-form/817e214a-bca2-4320-a58c-c499d9313d2e" },
    { acc: "$15,000", price: "$229", href: "https://app.hashhedge.com/en/app/payment-form/09535d91-26d6-46cc-8752-091eb74ee44b" },
    { acc: "$25,000", price: "$349", href: "https://app.hashhedge.com/en/app/payment-form/23cc5222-49fc-4d30-9387-94ffc1e32450" },
    { acc: "$30,000", price: "$419", href: "https://app.hashhedge.com/en/app/payment-form/a78b583b-b93d-45da-808a-aa905104b475" }
  ];
  ...
  var node = React.createElement("div", {
    ...
    React.createElement("div", { className: "hh1-popup-modal" },
      ...
      React.createElement("h2", { className: "hh1-popup-title" },
        'One-phase ', React.createElement("span", { className: "hh1-popup-accent" }, 'challenges')
      ),
      React.createElement("p", { className: "hh1-popup-sub" }, 'Get funded even faster — in just one stage.'),
      React.createElement("span", { className: "hh1-popup-timer-label" }, 'Sale ends in:'),
        ...
        cards.map(function(c, i) {
          return React.createElement("a", {
            ...
            React.createElement("div", { className: "hh1-popup-card-left" },
              React.createElement("span", { className: "hh1-popup-card-label" }, 'Account'),
            ...
            React.createElement("span", { className: "hh1-popup-card-btn" }, 'Buy')
          );
        })
      ),
      React.createElement("p", { className: "hh1-popup-disclaimer" }, 'Sale active until June 13, 2026, 15:00 (Dubai time). After the timer expires, access to the one-phase challenge will close automatically.')
    )
  );
