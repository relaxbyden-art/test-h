(function(){
  ...
  function Header() {
    ...
    const nav = [
      { l: "Sobre",     h: "#about-program" },
      { l: "Cómo funciona",    h: "#how" },
      { l: "Ganancias",           h: "#calc" },
      { l: "FAQ",             h: "#faq" },
      { l: "Challenge de trading", h: "https://hashhedge.com/", external: true }
    ];
    const langs = [
      ...
      { code: "ES", flag: "🇪🇸", label: "Español",          href: "#", current: true },
  ...
  function HeroCandles() {
    ...
    return _e("div", { "aria-hidden": true, className: "hh-hero-candles",
      style: { position: "absolute", inset: 0, pointerEventos: "none", zIndex: 0 }
    },
  ...
  function LivePartnerCard() {
    ...
    const payoutPool = [
      { flag: "🇷🇺", name: "Сергей",     city: "Moscú",       amt: 1850 },
    ...
    return _e("div", { className: "hh-live-card hh-glass",
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        pointerEventos: "none", zIndex: 1, borderRadius: "26px 26px 0 0"
      } }),
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        opacity: 0.7, pointerEventos: "none"
      } }),
      ...
      _e("div", { style: { padding: "20px 22px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" } },
        ...
        _e("div", { style: { marginTop: 20 } },
          ...
          _e("div", { style: { position: "relative", height: 8, borderRadius: 6, background: "rgba(255,255,255,0.06)", overflow: "hidden", border: "1px solid rgba(255,255,255,0.04)" } },
            ...
            // Shimmer-полоска
            _e("div", { style: {
              position: "absolute", inset: "0 24% 0 0", borderRadius: 6, overflow: "hidden", pointerEventos: "none"
            } },
              _e("div", { style: {
  ...
  function Hero() {
    ...
    // matrix-стене), большой H1 в 4 строки с акцентом на «gana junto a nosotros», 2 CTA,
    // ссылка «Calcula tus ganancias», блок Trustpilot снизу с 4-stat ряду.
    ...
    return _e("section", {
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 2 } },
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            ...
            _e("h1", { className: "hh-partner-hero-h1",
              ...
              "Promociona una firma prop", _e("br", null),
              "cripto de primer nivel", _e("br", null),
              "en todo el mundo y", _e("br", null),
              _e("span", { style: { color: "#fcd535" } }, "gana junto a nosotros")
            ),
            _e("p", { className: "hh-partner-hero-sub", style: {
              ...
              " por cada trader que refieras — pagos semanales en USDT, de por vida."
            ),
        ...
        _e("div", { className: "hh-partner-hero-stats", style: {
          ...
          _e("div", null,
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 8, whiteSpace: "nowrap" } }, "Alianza con una plataforma confiable"),
            _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10 } },
              _e("span", { style: { fontSize: 16, fontWeight: 800, color: "#f5f1e8" } }, "Excelente"),
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Traders financiados en el mundo")
          ),
          // $12M+
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Pagado a traders")
          ),
          // 4.4/5
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Países atendidos")
          )
        )
      )
    );
  ...
  function AboutProgram() {
    const cards = [
      { v: "hasta el 80%", t: "de las ganancias HashHedge",         b: "La mejor comisión del sector por cada trader referido." },
      { v: "Semanal", t: "pagos en USDT",            b: "Tus ganancias llegan a tu wallet cada lunes." },
      { v: "De por vida", t: "comisiones",                 b: "Ganas mientras el trader siga activo." },
      { v: "Minutos", t: "para ser aprobado",                   b: "Aprobación rápida, formalidades mínimas, enlace al instante." }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Las mejores condiciones", _e("br", null),
                "de afiliación ", _e("span", { style: { color: "#fcd535" } }, "del sector.")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "HashHedge da a los traders cripto ", _e("strong", { style: { color: "#f5f1e8" } }, "$5,000 to $100,000"),
              " para operar sin riesgo. Tu trabajo es simple — atrae a esos traders. A cambio, obtienes una parte de los ingresos que generan, con las condiciones más generosas que ofrece una firma prop."
            )
          )
        ),
          ...
          cards.map((c, i) => _e(Reveal, { key: i, delay: String((i % 4) + 1) },
            _e("div", { className: "hh-about-card", style: {
              ...
              _e("div", { style: {
                ...
                marginBottom: 12,
                fontFamily: "Onest, sans-serif",
                textTransform: c.v === "hasta el 80%" || c.v === "Minutos" || c.v === "De por vida" || c.v === "Semanal" ? "none" : "uppercase"
              } }, c.v),
  ...
  function WhyPartner() {
    ...
    const V1 = () => isMobile
      ? _e("div", { className: "hh-v1 hh-v1-mobile", style: { width: "100%", textAlign: "center", padding: "0 4px", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" } },
          _e("div", { style: { fontSize: 38, fontWeight: 900, color: "#fcd535", lineHeight: 1, letterSpacing: "-0.03em" } }, "hasta el 80%"),
    ...
    // V9 — Red multinivel. Картинка увеличена (viewBox шире), круги с непрозрачным фоном.
    const V9 = () => _e("div", { style: { width: "100%", padding: 0, position: "relative" } },
      _e("svg", { width: "100%", height: 180, viewBox: "0 0 220 130", style: { display: "block" } },
        ...
        _e("text", { x: 110, y: 33, textAnchor: "middle", style: { fontSize: 11, fontWeight: 800, fill: "#13111c" } }, "TÚ"),
    ...
    const cards = [
      { viz: _e(V1, null), chip: "Top in the prop industry", title: "Hasta el 80% de los beneficios Hash Hedge", titleAccent: "before",
      ...
      { viz: _e(V2, null), chip: "One trader = lifetime income", title: "Comisiones de por vida", titleAccent: "before",
        body: "Every trader is locked to you for life. You earn from every single purchase they make." },
      { viz: _e(V3, null), chip: "Better than exchange offers", title: "Más beneficio que en exchanges",
        body: "One funded trader with a $25–50K account brings in 5–10× more than a standard exchange referral." },
      { viz: _e(V4, null), chip: "Withdrawals within 72 hours", title: "Pagos rápidos", titleAccent: "before",
        body: "Request a USDT withdrawal any time. Funds reach your wallet within 72 hours." },
      { viz: _e(V5, null), chip: "Grow automatically", title: "7 niveles de socio", titleAccent: "before",
      ...
      // === 3 новые карточки ===
      { viz: _e(V7, null), chip: "Discounts for your audience", title: "Códigos promo para tu audiencia", titleAccent: "before",
        body: "Get personal discounts for your audience to boost conversion and drive purchases through your link." },
      { viz: _e(V8, null), chip: "Traffic analytics", title: "Tracking flexible",
        body: "Build custom links to segment traffic and track conversions in your partner dashboard." },
      { viz: _e(V9, null), chip: "Red multinivel", title: "Programa subafiliados",
  ...
  function IncomeSources() {
    ...
    const sources = [
      { n: "01", title: "Comisión por ventas",
        body: _e(F, null, "Earn ", _e("b", { style: { color: "#fcd535" } }, "hasta el 80%"), " of Hash Hedge profit on every purchase. Referrals are locked to you for life: bring them in once, earn from every future purchase."),
        pill: "Ingresos recurrentes",
      ...
      { n: "03", title: "Programa subafiliados",
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 760, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Tu enlace de afiliado puede generar ingresos de tres fuentes a la vez.")
          )
        ),
          ...
          sources.map((s, i) => _e(Reveal, { key: i, delay: String(i + 1) },
            _e("div", { className: "hh-income-card",
              ...
              _e("div", { "aria-hidden": true, style: {
                ...
                pointerEventos: "none", userSelect: "none"
              } }, s.n),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 880, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Atrae traders and take hasta el 80% of Hash Hedge profit.")
          )
        ),
        ...
        _e("div", { className: "hh-bp-wrap", style: {
            ...
            _e("div", { className: "hh-bp-track-inner", style: {
              ...
              tiers.map((t, i) => {
                ...
                return _e("button", { key: t.lvl, type: "button",
                  ...
                  "aria-label": `Nivel ${t.lvl} ${t.label}, комиссия ${t.pct}%`,
                  style: {
          ...
          } }, "Pulsa cualquier nivel →  ver detalles")
        ),
        ...
        _e("div", { style: { textAlign: "center", fontSize: 13, color: "#a1a0a4" } },
          "Nivel recalculates automatically each month based on the number of active referred traders"
        )
      )
    );
  }
      ...
      _e("div", { className: "container" },
          ...
          _e("div", { className: "hh-calc-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { className: "hh-calc-h2", style: { fontSize: "clamp(32px, 4vw, 48px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Cuanto más traigas,", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "mayor tu comisión.")
              )
            ),
        ...
        _e("div", { className: "hh-calc-grid", style: {
          ...
          _e("div", { className: "hh-calc-card", style: {
            ...
            _e("div", { style: { fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a7a80", marginBottom: 24 } }, "Calculadora de ganancias"),
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 } },
              _e("div", { style: { fontSize: 14, color: "#a1a0a4" } }, "Traders referidos activos"),
            ...
            _e("div", { style: { display: "flex", gap: 12, marginTop: 28 } },
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Tu nivel"),
                _e("div", { style: { fontSize: 26, fontWeight: 800, color: "#fcd535", lineHeight: 1, fontFamily: "Onest, sans-serif" } }, currentTier.pct + "%"),
                _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Nivel " + currentTier.lvl)
              ),
              _e("div", { style: {
                flex: 1,
                padding: "16px 18px",
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Promedio / trader / mes"),
            ...
            _e("div", { style: { marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--line)" } },
              _e("div", { style: { fontSize: 13, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 } }, "Pago mensual estimado"),
              ...
              _e("p", { style: { fontSize: 11, color: "#6b6a70", lineHeight: 1.5, margin: "18px 0 0" } },
                "Solo a modo ilustrativo. Las ganancias reales dependen de la actividad del trader y el tamaño de la cuenta."
              )
            )
          ),
            ...
            tiers.map(t => {
              ...
              return _e("button", { key: t.lvl, type: "button",
                ...
                _e("div", { style: { flex: 1, minWidth: 0, marginLeft: 16, position: "relative", zIndex: 1 } },
                  _e("div", { className: "hh-calc-tier-name", style: { fontSize: 13, fontWeight: 700, color: "#a1a0a4" } }, "Nivel " + t.lvl),
  ...
  function Steps() {
    const steps = [
      { n: "01", chip: "Regístrate",       title: "Registro",
      ...
      { n: "03", chip: "Promotion",       title: "Atrae traders",
        body: "Share your link on socials, Telegram channels, YouTube, blogs or personal recommendations." },
      { n: "04", chip: "Ganancias",             title: "Recibe pagos",
        body: "Recibe hasta el 80% of Hash Hedge profit for referred traders. Payouts in USDT within 72 hours." }
    ];
              ...
              _e("div", { className: "hh-cab-top-right", style: { display: "flex", alignItems: "center", gap: 10 } },
                _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10, padding: "6px 12px", border: "1px solid rgba(74,222,128,0.4)", borderRadius: 100, background: "rgba(8,8,10,0.5)" } },
                  ...
                  _e("div", { style: { lineHeight: 1.2 } },
                    ...
                    _e("div", { style: { fontSize: 10, color: "#a1a0a4" } }, "Tu manager personal")
                  )
                ),
        ...
        _e(Reveal, { delay: "3" },
          _e("div", { className: "hh-cab-explainers", style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 } },
            [
              ...
              { paths: ["M22 11.08V12a10 10 0 1 1-5.93-9.14", "M22 4L12 14.01l-3-3"], t: "Sub-affiliate statistics", b: "Track comisiones from all levels: your direct partners and their referrals." },
  ...
  function PartnerContent() {
    ...
    const videos = [
      ...
      { id: "oz_72s2S5Xc", title: "Platform & de afiliación breakdown",                                     author: "@cryptoschool",views: "41K"  },
  ...
  function Eventos() {
    ...
    const events = [
      // [0] = hero big
      { flag: "🇦🇪", city: "Dubai",     year: "October 2025", role: "Organizador", title: "WSCT Dubai · Live Tournament",     img: "https://hash-hedge-partner.vercel.app/assets/event-dubai.jpg" },
      // [1], [2] = stacked справа
      { flag: "🇷🇺", city: "Moscú",    year: "2025",          role: null,           title: "Socios at Blockchain Forum",     img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/event-blockchain-forum.jpg" },
      { flag: "🇧🇷", city: "São Paulo", year: "2025",          role: "Organizador", title: "WSCT Brazil · Live Tournament",   img: "https://hash-hedge-partner.vercel.app/assets/event-saopaulo.jpeg" },
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "Moscú",    year: "2026",          role: null,           title: "Encuentro de afiliados",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "Moscú",    year: "2026",          role: "Organizador", title: "Premios Top Affiliate",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇷🇺", city: "Moscú",    year: "2026",          role: "Embajador Hash Hedge", title: "Nikita Anufriev",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇷🇺", city: "Moscú",    year: "2026",          role: null,           title: "Encuentro de afiliados",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
    const Card = ({ ev, size }) => _e("div", {
      ...
      _e("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 45%, rgba(0,0,0,0.88) 100%)", pointerEventos: "none" } }),
  ...
  function TelegramCommunity() {
    ...
    const channelsBase = [
      ...
      { ic: "📣", name: "Socios chat",   sub: "Друзья, всем привет! Напоминаем…",     time: "ПТ",     unread: 13 },
    ...
    const tgScenes = [
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Максим · Алматы 🇰🇿: только что прошёл Nivel 3 🔥",              time: "сейчас",  unread: 1 } } },
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Olga · Moscú: спасибо за промо-материалы, забрала 🤝",          time: "сейчас",  unread: 3 } } }
    ];
    ...
    return _e("section", { id: "telegram", "data-no-glow": true,
      ...
      _e("div", { "aria-hidden": true, className: "glow", style: {
        ...
        filter: "blur(120px)", opacity: 0.07, pointerEventos: "none", zIndex: 0
      } }),
      _e("style", null, `
            ...
            _e("div", { ref: tgRef, style: { maxWidth: 380, margin: "0 auto", position: "relative", opacity: 1 } },
              _e("div", {
                ...
                _e("div", { style: { background: "#0e0e10", borderRadius: 40, overflow: "hidden", position: "relative" } },
                  ...
                  // Затем в активном канале «Socios chat» по сценарию меняется sub/badge — имитация переписки.
        ...
        _e("div", { className: "hh-support-grid", style: {
          ...
          _e(Reveal, null,
            _e("div", { style: {
              ...
              _e("img", { src: SUP_BASE + "assets/tati.jpg", alt: "Tati — Jefa de Afiliados",
              ...
              _e("div", { className: "hh-tati-badge", style: {
                ...
                _e("div", null,
                  ...
                  _e("div", { style: { fontSize: 12, color: "#cfcfd3", marginTop: 2 } }, "Jefa de Afiliados")
                ),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "Preguntas frecuentes"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "Todo lo que necesitas saber del programa de afiliados.")
          )
        ),
        _e(Reveal, { delay: "1" },
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 1 } },
        _e(Reveal, null,
          ...
          _e("div", {
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerEventos: "none", opacity: 0.6 } },
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerEventos: "none" } },
            ...
            _e("div", { "aria-hidden": true, style: {
              position: "absolute", inset: 0, pointerEventos: "none",
  ...
  function Footer() {
    const columns = [
      { t: "Producto", l: [
        ...
        { label: "Programa de afiliados",  href: "https://www.hashhedge.com/affiliateprogram" },
        { label: "Blog",                   href: "https://www.hashhedge.com/blog" },
        { label: "Guía",            href: "https://hashhedge.gitbook.io/hashhedge-user-guide" }
      ]},
      { t: "Empresa", l: [
        { label: "Soporte", href: "https://t.me/hashhedgesupportbot" },
        { label: "FAQ",       href: "https://www.hashhedge.com/faq" },
        { label: "Empleos",  href: "https://www.hashhedge.com/vacancies" }
      ]},
      { t: "Legal", l: [
        { label: "Privacidad", href: "https://www.hashhedge.com/privacy-policy" },
        { label: "Términos",       href: "https://www.hashhedge.com/terms-and-conditions" },
        { label: "Condiciones comerciales",        href: "https://www.hashhedge.com/commercial-terms" },
        { label: "Política de socios",        href: "https://www.hashhedge.com/affiliate-politics" }
      ]}
    ];
    const partners = [
    ...
    return _e("footer", { style: { padding: "88px 0 64px", background: "var(--bg-elev)", borderTop: "1px solid var(--line)" } },
      _e("div", { className: "container", style: { maxWidth: 1180 } },
        ...
        _e("div", { style: { textAlign: "center" } },
          _e("div", { style: { fontSize: 16, color: "rgba(238,238,243,0.86)", marginBottom: 34 } }, "© 2026 HashHedge. Todos los derechos reservados."),
  ...
  if (!document.getElementById("hh-partner-styles")) {
    ...
    st.textContent = `
      ...
      /* v12.11 — ссылка «Calcula tus ganancias»: белое подчёркивание + hover-анимация */
      ...
      /* v12.11 — фото Tati: быстрый hover-zoom как у карточек Eventos en vivo */
      ...
      @media (max-width: 980px) {
        ...
        /* v11.0 Eventos: на планшете top→1кол, bottom→2кол */
      ...
      @media (max-width: 640px) {
        ...
        /* === v10.2 mobile: Eventos — 1 hero + horizontal slider === */
        .hh-events-grid {
          display: flex !important;
          grid-template-columns: none !important;
          overflow-x: auto !important;
        ...
        /* === (v3.7 #5) Calculator: тексты одного размера, блок «Tu nivel» компактнее === */
        ...
        /* Eventos — все 4 карточки одного размера + единый title 18px */
      ...
      @media (max-width: 980px) {
        ...
        /* (4) Eventos — big card компактнее + горизонтальный слайдер остального */
