...
(function(){
  ...
  loadCss("https://fonts.googleapis.com/css2?family=Onest:wght@400;500;600;700;800;900&display=swap")
    .then(function(){ return loadCss(base + "hashhedge-react.css?v=20260506-slider-8"); })
    ...
    .then(function(){ return loadScript(base + "hashhedge-react-app.js?v=20260506-slider-8"); })
