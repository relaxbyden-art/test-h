(function(){
  ...
  function Header() {
    ...
    const nav = [
      { l: "प्रोग्राम",     h: "#about-program" },
      { l: "कैसे काम करता है",    h: "#how" },
      { l: "कमाई",           h: "#calc" },
      { l: "FAQ",             h: "#faq" },
      { l: "ट्रेडिंग चैलेंज", h: "https://hashhedge.com/", external: true }
    ];
    const langs = [
      ...
      { code: "HI", flag: "🇮🇳", label: "हिन्दी",            href: "#", current: true },
  ...
  function HeroCandles() {
    ...
    return _e("div", { "aria-hidden": true, className: "hh-hero-candles",
      style: { position: "absolute", inset: 0, pointerइवेंट्स: "none", zIndex: 0 }
    },
  ...
  function LivePartnerCard() {
    ...
    const payoutPool = [
      { flag: "🇷🇺", name: "Сергей",     city: "मॉस्को",       amt: 1850 },
    ...
    return _e("div", { className: "hh-live-card hh-glass",
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        pointerइवेंट्स: "none", zIndex: 1, borderRadius: "26px 26px 0 0"
      } }),
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        opacity: 0.7, pointerइवेंट्स: "none"
      } }),
      ...
      _e("div", { style: { padding: "20px 22px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" } },
        ...
        _e("div", { style: { marginTop: 20 } },
          ...
          _e("div", { style: { position: "relative", height: 8, borderRadius: 6, background: "rgba(255,255,255,0.06)", overflow: "hidden", border: "1px solid rgba(255,255,255,0.04)" } },
            ...
            // Shimmer-полоска
            _e("div", { style: {
              position: "absolute", inset: "0 24% 0 0", borderRadius: 6, overflow: "hidden", pointerइवेंट्स: "none"
            } },
              _e("div", { style: {
  ...
  function Hero() {
    ...
    // matrix-стене), большой H1 в 4 строки с акцентом на «साथ कमाएँ», 2 CTA,
    // ссылка «अपनी कमाई कैलकुलेट करें», блок Trustpilot снизу с 4-stat ряду.
    ...
    return _e("section", {
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 2 } },
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            ...
            _e("h1", { className: "hh-partner-hero-h1",
              ...
              "एक टॉप क्रिप्टो प्रॉप", _e("br", null),
              "फर्म को प्रमोट करें", _e("br", null),
              "दुनिया भर में और", _e("br", null),
              _e("span", { style: { color: "#fcd535" } }, "साथ कमाएँ")
            ),
            _e("p", { className: "hh-partner-hero-sub", style: {
              ...
              " तक हर रेफर किए गए ट्रेडर पर — हर हफ्ते USDT में, जीवनभर।"
            ),
        ...
        _e("div", { className: "hh-partner-hero-stats", style: {
          ...
          _e("div", null,
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 8, whiteSpace: "nowrap" } }, "भरोसेमंद प्लेटफॉर्म के साथ साझेदारी"),
            _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10 } },
              _e("span", { style: { fontSize: 16, fontWeight: 800, color: "#f5f1e8" } }, "बेहतरीन"),
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "दुनिया भर के फंडेड ट्रेडर्स")
          ),
          // $12M+
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "ट्रेडर्स को भुगतान")
          ),
          // 4.4/5
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "देशों में सेवा")
          )
        )
      )
    );
  ...
  function AboutProgram() {
    const cards = [
      { v: "80% तक", t: "HashHedge प्रॉफिट का",         b: "इंडस्ट्री में सबसे ज़्यादा रेवेन्यू शेयर।" },
      { v: "साप्ताहिक", t: "USDT में भुगतान",            b: "हर सोमवार आपकी वॉलेट में कमाई।" },
      { v: "जीवनभर", t: "कमाई",                 b: "जब तक ट्रेडर एक्टिव है, आप कमाते हैं।" },
      { v: "मिनट", t: "अप्रूव होने में",                   b: "तेज़ अप्रूवल, न्यूनतम औपचारिकता, तुरंत लिंक।" }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "इंडस्ट्री की सबसे", _e("br", null),
                "उदार एफिलिएट ", _e("span", { style: { color: "#fcd535" } }, "शर्तें।")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "HashHedge क्रिप्टो ट्रेडर्स को ", _e("strong", { style: { color: "#f5f1e8" } }, "$5,000 to $100,000"),
              " देता है ताकि वे बिना जोखिम के ट्रेड करें। आपका काम सरल है — उन ट्रेडर्स को लाना। बदले में आप उनके रेवेन्यू का हिस्सा पाते हैं, सबसे उदार शर्तों पर।"
            )
          )
        ),
          ...
          cards.map((c, i) => _e(Reveal, { key: i, delay: String((i % 4) + 1) },
            _e("div", { className: "hh-about-card", style: {
              ...
              _e("div", { style: {
                ...
                marginBottom: 12,
                fontFamily: "Onest, sans-serif",
                textTransform: c.v === "80% तक" || c.v === "मिनट" || c.v === "जीवनभर" || c.v === "साप्ताहिक" ? "none" : "uppercase"
              } }, c.v),
  ...
  function WhyPartner() {
    ...
    const V1 = () => isMobile
      ? _e("div", { className: "hh-v1 hh-v1-mobile", style: { width: "100%", textAlign: "center", padding: "0 4px", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" } },
          _e("div", { style: { fontSize: 38, fontWeight: 900, color: "#fcd535", lineHeight: 1, letterSpacing: "-0.03em" } }, "80% तक"),
    ...
    // V9 — मल्टी-टियर नेटवर्क. Картинка увеличена (viewBox шире), круги с непрозрачным фоном.
    const V9 = () => _e("div", { style: { width: "100%", padding: 0, position: "relative" } },
      _e("svg", { width: "100%", height: 180, viewBox: "0 0 220 130", style: { display: "block" } },
        ...
        _e("text", { x: 110, y: 33, textAnchor: "middle", style: { fontSize: 11, fontWeight: 800, fill: "#13111c" } }, "आप"),
    ...
    const cards = [
      { viz: _e(V1, null), chip: "Top in the prop industry", title: "Hash Hedge प्रॉफिट का 80% तक", titleAccent: "before",
      ...
      { viz: _e(V2, null), chip: "One trader = lifetime income", title: "जीवनभर कमाई", titleAccent: "before",
        body: "Every trader is locked to you for life. You earn from every single purchase they make." },
      { viz: _e(V3, null), chip: "Better than exchange offers", title: "एक्सचेंज से ज़्यादा प्रॉफिट",
        body: "One funded trader with a $25–50K account brings in 5–10× more than a standard exchange referral." },
      { viz: _e(V4, null), chip: "Withdrawals within 72 hours", title: "तेज़ पेआउट", titleAccent: "before",
        body: "Request a USDT withdrawal any time. Funds reach your wallet within 72 hours." },
      { viz: _e(V5, null), chip: "Grow automatically", title: "7 पार्टनर लेवल", titleAccent: "before",
      ...
      // === 3 новые карточки ===
      { viz: _e(V7, null), chip: "Discounts for your audience", title: "ऑडियंस के लिए प्रोमो कोड", titleAccent: "before",
        body: "Get personal discounts for your audience to boost conversion and drive purchases through your link." },
      { viz: _e(V8, null), chip: "Traffic analytics", title: "फ्लेक्सिबल ट्रैकिंग",
        body: "Build custom links to segment traffic and track conversions in your partner dashboard." },
      { viz: _e(V9, null), chip: "मल्टी-टियर नेटवर्क", title: "सब-एफिलिएट प्रोग्राम",
  ...
  function IncomeSources() {
    ...
    const sources = [
      { n: "01", title: "बिक्री कमीशन",
        body: _e(F, null, "Earn ", _e("b", { style: { color: "#fcd535" } }, "80% तक"), " of Hash Hedge profit on every purchase. Referrals are locked to you for life: bring them in once, earn from every future purchase."),
        pill: "रिकरिंग इनकम",
      ...
      { n: "03", title: "सब-एफिलिएट प्रोग्राम",
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 760, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "आपका एफिलिएट लिंक एक साथ तीन स्रोतों से इनकम दे सकता है।")
          )
        ),
          ...
          sources.map((s, i) => _e(Reveal, { key: i, delay: String(i + 1) },
            _e("div", { className: "hh-income-card",
              ...
              _e("div", { "aria-hidden": true, style: {
                ...
                pointerइवेंट्स: "none", userSelect: "none"
              } }, s.n),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 880, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "ट्रेडर्स लाएँ and take 80% तक of Hash Hedge profit.")
          )
        ),
        ...
        _e("div", { className: "hh-bp-wrap", style: {
            ...
            _e("div", { className: "hh-bp-track-inner", style: {
              ...
              tiers.map((t, i) => {
                ...
                return _e("button", { key: t.lvl, type: "button",
                  ...
                  "aria-label": `लेवल ${t.lvl} ${t.label}, комиссия ${t.pct}%`,
                  style: {
          ...
          } }, "किसी भी टियर पर क्लिक करें →  विवरण देखें")
        ),
        ...
        _e("div", { style: { textAlign: "center", fontSize: 13, color: "#a1a0a4" } },
          "लेवल recalculates automatically each month based on the number of active referred traders"
        )
      )
    );
  }
  ...
  function Calculator() {
    const tiers = [
      { lvl: 1, pct: 50, min: 0,   max: 14,  range: "0–14 ट्रेडर्स" },
      { lvl: 2, pct: 55, min: 15,  max: 49,  range: "15–49 ट्रेडर्स" },
      { lvl: 3, pct: 60, min: 50,  max: 99,  range: "50–99 ट्रेडर्स" },
      { lvl: 4, pct: 65, min: 100, max: 199, range: "100–199 ट्रेडर्स" },
      { lvl: 5, pct: 70, min: 200, max: 399, range: "200–399 ट्रेडर्स" },
      { lvl: 6, pct: 75, min: 400, max: 699, range: "400–699 ट्रेडर्स" },
      { lvl: 7, pct: 80, min: 700, max: 999, range: "700+ ट्रेडर्स" }
    ];
      ...
      _e("div", { className: "container" },
          ...
          _e("div", { className: "hh-calc-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { className: "hh-calc-h2", style: { fontSize: "clamp(32px, 4vw, 48px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "जितना ज़्यादा लाएँगे,", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "उतना बड़ा हिस्सा।")
              )
            ),
        ...
        _e("div", { className: "hh-calc-grid", style: {
          ...
          _e("div", { className: "hh-calc-card", style: {
            ...
            _e("div", { style: { fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a7a80", marginBottom: 24 } }, "कमाई कैलकुलेटर"),
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 } },
              _e("div", { style: { fontSize: 14, color: "#a1a0a4" } }, "एक्टिव रेफर्ड ट्रेडर्स"),
            ...
            _e("div", { style: { display: "flex", gap: 12, marginTop: 28 } },
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "आपका टियर"),
                _e("div", { style: { fontSize: 26, fontWeight: 800, color: "#fcd535", lineHeight: 1, fontFamily: "Onest, sans-serif" } }, currentTier.pct + "%"),
                _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "लेवल " + currentTier.lvl)
              ),
              _e("div", { style: {
                flex: 1,
                padding: "16px 18px",
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "औसत / ट्रेडर / माह"),
            ...
            _e("div", { style: { marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--line)" } },
              _e("div", { style: { fontSize: 13, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 } }, "अनुमानित मासिक पेआउट"),
              ...
              _e("div", { style: { fontSize: 15, color: "#a1a0a4", marginTop: 10 } },
                ...
                " / साल · साप्ताहिक USDT में"
              ),
              _e("p", { style: { fontSize: 11, color: "#6b6a70", lineHeight: 1.5, margin: "18px 0 0" } },
                "केवल अनुमान। वास्तविक कमाई ट्रेडर एक्टिविटी और अकाउंट साइज़ पर निर्भर।"
              )
            )
          ),
            ...
            tiers.map(t => {
              ...
              return _e("button", { key: t.lvl, type: "button",
                ...
                _e("div", { style: { flex: 1, minWidth: 0, marginLeft: 16, position: "relative", zIndex: 1 } },
                  _e("div", { className: "hh-calc-tier-name", style: { fontSize: 13, fontWeight: 700, color: "#a1a0a4" } }, "लेवल " + t.lvl),
  ...
  function Steps() {
    const steps = [
      { n: "01", chip: "साइन अप",       title: "रजिस्टर",
      ...
      { n: "03", chip: "Promotion",       title: "ट्रेडर्स लाएँ",
        body: "Share your link on socials, Telegram channels, YouTube, blogs or personal recommendations." },
      { n: "04", chip: "कमाई",             title: "भुगतान पाएँ",
        body: "पाएँ 80% of Hash Hedge profit for referred traders. Payouts in USDT within 72 hours." }
    ];
              ...
              _e("div", { className: "hh-cab-top-right", style: { display: "flex", alignItems: "center", gap: 10 } },
                _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10, padding: "6px 12px", border: "1px solid rgba(74,222,128,0.4)", borderRadius: 100, background: "rgba(8,8,10,0.5)" } },
                  ...
                  _e("div", { style: { lineHeight: 1.2 } },
                    ...
                    _e("div", { style: { fontSize: 10, color: "#a1a0a4" } }, "आपका पर्सनल मैनेजर")
                  )
                ),
        ...
        _e(Reveal, { delay: "3" },
          _e("div", { className: "hh-cab-explainers", style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 } },
            [
              ...
              { paths: ["M22 11.08V12a10 10 0 1 1-5.93-9.14", "M22 4L12 14.01l-3-3"], t: "Sub-affiliate statistics", b: "Track कमाई from all levels: your direct partners and their referrals." },
  ...
  function PartnerContent() {
    ...
    const videos = [
      ...
      { id: "oz_72s2S5Xc", title: "Platform & उदार एफिलिएट breakdown",                                     author: "@cryptoschool",views: "41K"  },
  ...
  function इवेंट्स() {
    ...
    const events = [
      // [0] = hero big
      { flag: "🇦🇪", city: "Dubai",     year: "October 2025", role: "आयोजक", title: "WSCT Dubai · Live Tournament",     img: "https://hash-hedge-partner.vercel.app/assets/event-dubai.jpg" },
      // [1], [2] = stacked справа
      { flag: "🇷🇺", city: "मॉस्को",    year: "2025",          role: null,           title: "पार्टनर्स at Blockchain Forum",     img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/event-blockchain-forum.jpg" },
      { flag: "🇧🇷", city: "São Paulo", year: "2025",          role: "आयोजक", title: "WSCT Brazil · Live Tournament",   img: "https://hash-hedge-partner.vercel.app/assets/event-saopaulo.jpeg" },
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "मॉस्को",    year: "2026",          role: null,           title: "एफिलिएट मीटअप",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "मॉस्को",    year: "2026",          role: "आयोजक", title: "टॉप एफिलिएट अवॉर्ड्स",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇷🇺", city: "मॉस्को",    year: "2026",          role: "Hash Hedge एंबेसडर", title: "Nikita Anufriev",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇷🇺", city: "मॉस्को",    year: "2026",          role: null,           title: "एफिलिएट मीटअप",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
    const Card = ({ ev, size }) => _e("div", {
      ...
      _e("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 45%, rgba(0,0,0,0.88) 100%)", pointerइवेंट्स: "none" } }),
  ...
  function TelegramCommunity() {
    ...
    const channelsBase = [
      ...
      { ic: "📣", name: "पार्टनर्स chat",   sub: "Друзья, всем привет! Напоминаем…",     time: "ПТ",     unread: 13 },
    ...
    const tgScenes = [
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Максим · Алматы 🇰🇿: только что прошёл लेवल 3 🔥",              time: "сейчас",  unread: 1 } } },
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Olga · मॉस्को: спасибо за промо-материалы, забрала 🤝",          time: "сейчас",  unread: 3 } } }
    ];
    ...
    return _e("section", { id: "telegram", "data-no-glow": true,
      ...
      _e("div", { "aria-hidden": true, className: "glow", style: {
        ...
        filter: "blur(120px)", opacity: 0.07, pointerइवेंट्स: "none", zIndex: 0
      } }),
      _e("style", null, `
            ...
            _e("div", { ref: tgRef, style: { maxWidth: 380, margin: "0 auto", position: "relative", opacity: 1 } },
              _e("div", {
                ...
                _e("div", { style: { background: "#0e0e10", borderRadius: 40, overflow: "hidden", position: "relative" } },
                  ...
                  // Затем в активном канале «पार्टनर्स chat» по сценарию меняется sub/badge — имитация переписки.
        ...
        _e("div", { className: "hh-support-grid", style: {
          ...
          _e(Reveal, null,
            _e("div", { style: {
              ...
              _e("img", { src: SUP_BASE + "assets/tati.jpg", alt: "Tati — हेड ऑफ़ एफिलिएट्स",
              ...
              _e("div", { className: "hh-tati-badge", style: {
                ...
                _e("div", null,
                  ...
                  _e("div", { style: { fontSize: 12, color: "#cfcfd3", marginTop: 2 } }, "हेड ऑफ़ एफिलिएट्स")
                ),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "अक्सर पूछे जाने वाले प्रश्न"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "एफिलिएट प्रोग्राम के बारे में जानने योग्य सब कुछ.")
          )
        ),
        _e(Reveal, { delay: "1" },
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 1 } },
        _e(Reveal, null,
          ...
          _e("div", {
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerइवेंट्स: "none", opacity: 0.6 } },
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerइवेंट्स: "none" } },
            ...
            _e("div", { "aria-hidden": true, style: {
              position: "absolute", inset: 0, pointerइवेंट्स: "none",
  ...
  function Footer() {
    const columns = [
      { t: "प्रोडक्ट", l: [
        { label: "चैलेंज",              href: "https://www.hashhedge.com/#challenge" },
        { label: "एफिलिएट प्रोग्राम",  href: "https://www.hashhedge.com/affiliateprogram" },
        { label: "Blog",                   href: "https://www.hashhedge.com/blog" },
        { label: "यूज़र गाइड",            href: "https://hashhedge.gitbook.io/hashhedge-user-guide" }
      ]},
      { t: "कंपनी", l: [
        { label: "सपोर्ट", href: "https://t.me/hashhedgesupportbot" },
        { label: "FAQ",       href: "https://www.hashhedge.com/faq" },
        { label: "करियर",  href: "https://www.hashhedge.com/vacancies" }
      ]},
      { t: "कानूनी", l: [
        { label: "प्राइवेसी", href: "https://www.hashhedge.com/privacy-policy" },
        { label: "शर्तें",       href: "https://www.hashhedge.com/terms-and-conditions" },
        { label: "कमर्शियल शर्तें",        href: "https://www.hashhedge.com/commercial-terms" },
        { label: "पार्टनर नीति",        href: "https://www.hashhedge.com/affiliate-politics" }
      ]}
    ];
    const partners = [
    ...
    return _e("footer", { style: { padding: "88px 0 64px", background: "var(--bg-elev)", borderTop: "1px solid var(--line)" } },
      _e("div", { className: "container", style: { maxWidth: 1180 } },
        ...
        _e("div", { style: { textAlign: "center" } },
          _e("div", { style: { fontSize: 16, color: "rgba(238,238,243,0.86)", marginBottom: 34 } }, "© 2026 HashHedge. सभी अधिकार सुरक्षित।"),
  ...
  if (!document.getElementById("hh-partner-styles")) {
    ...
    st.textContent = `
      ...
      /* v12.11 — ссылка «अपनी कमाई कैलकुलेट करें»: белое подчёркивание + hover-анимация */
      ...
      /* v12.11 — фото Tati: быстрый hover-zoom как у карточек लाइव इवेंट्स */
      ...
      @media (max-width: 980px) {
        ...
        /* v11.0 इवेंट्स: на планшете top→1кол, bottom→2кол */
      ...
      @media (max-width: 640px) {
        ...
        /* === v10.2 mobile: इवेंट्स — 1 hero + horizontal slider === */
        .hh-events-grid {
          display: flex !important;
          grid-template-columns: none !important;
          overflow-x: auto !important;
        ...
        /* === (v3.7 #5) Calculator: тексты одного размера, блок «आपका टियर» компактнее === */
        ...
        /* Компактный блок «आपका टियर · авто» */
        ...
        /* इवेंट्स — все 4 карточки одного размера + единый title 18px */
      ...
      @media (max-width: 980px) {
        ...
        /* (4) इवेंट्स — big card компактнее + горизонтальный слайдер остального */
