(function(){
  ...
  function LivePartnerCard() {
    ...
    const payoutPool = [
      { flag: "🇷🇺", name: "Сергей",     city: "Moscow",       amt: 1850 },
  ...
  function Hero() {
    ...
    // matrix-стене), большой H1 в 4 строки с акцентом на «earn together», 2 CTA,
    // ссылка «Calculate your earnings», блок Trustpilot снизу с 4-stat ряду.
        ...
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            ...
            _e("p", { className: "hh-partner-hero-sub", style: {
              ...
              " for every trader you refer — paid weekly in USDT, for life."
            ),
  ...
  function AboutProgram() {
    const cards = [
      { v: "up to 80%", t: "of HashHedge profits",         b: "Industry-topping revenue share per referred trader." },
      { v: "Weekly", t: "payments in USDT",            b: "Earnings land in your wallet every Monday." },
      { v: "Lifetime", t: "accruals",                 b: "You earn for as long as the trader stays active." },
      { v: "Minutes", t: "to get approved",                   b: "Fast approval, minimal formalities, instant link." }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                ...
                "terms ", _e("span", { style: { color: "#fcd535" } }, "in the industry.")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "HashHedge gives crypto traders ", _e("strong", { style: { color: "#f5f1e8" } }, "$5,000 to $100,000"),
              " to trade risk-free. Your job is simple — bring those traders in. In return you get a cut of the revenue they generate, on the most generous terms a prop firm offers."
            )
          )
        ),
          ...
          cards.map((c, i) => _e(Reveal, { key: i, delay: String((i % 4) + 1) },
            _e("div", { className: "hh-about-card", style: {
              ...
              _e("div", { style: {
                ...
                marginBottom: 12,
                fontFamily: "Onest, sans-serif",
                textTransform: c.v === "up to 80%" || c.v === "Minutes" || c.v === "Lifetime" || c.v === "Weekly" ? "none" : "uppercase"
              } }, c.v),
  ...
  function Events() {
    ...
    const events = [
      ...
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "Moscow",    year: "2026",          role: null,           title: "Affiliate Meetup",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "Moscow",    year: "2026",          role: "Organizer", title: "Top Affiliate Awards",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇷🇺", city: "Moscow",    year: "2026",          role: "Hash Hedge Ambassador", title: "Nikita Anufriev",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇷🇺", city: "Moscow",    year: "2026",          role: null,           title: "Affiliate Meetup",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
  ...
  function TelegramCommunity() {
    ...
    const tgScenes = [
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Olga · Moscow: спасибо за промо-материалы, забрала 🤝",          time: "сейчас",  unread: 3 } } }
    ];
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "Frequently asked questions"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "Everything you need to know about the affiliate programme.")
          )
        ),
        _e(Reveal, { delay: "1" },
  ...
  if (!document.getElementById("hh-partner-styles")) {
    ...
    st.textContent = `
      ...
      @media (max-width: 640px) {
        ...
        /* Компактный блок «Your tier · авто» */
