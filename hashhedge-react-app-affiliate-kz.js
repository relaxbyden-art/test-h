(function(){
  ...
  function HashHedgeLogo({ size = 28, wordmarkColor = "var(--fg)" }) {
    const h = size;
    return _e("a", { href: "https://www.hashhedge.com/kz", className: "hh-logo",
  ...
  function Header() {
    ...
    const nav = [
      { l: "Бағдарлама туралы",   h: "#about-program" },
      { l: "Қалай жұмыс істейді", h: "#how" },
      { l: "Табыс",               h: "#calc" },
      { l: "FAQ",                 h: "#faq" },
      { l: "Челлендж сатып алу",  h: "https://hashhedge.com/", external: true }
    ];
    const langs = [
      ...
      { code: "KZ", flag: "🇰🇿", label: "Қазақша",          href: "#", current: true }
    ];
  ...
  function LivePartnerCard() {
    ...
    const payoutPool = [
      { flag: "🇷🇺", name: "Сергей",     city: "Мәскеу",       amt: 1850 },
      ...
      { flag: "🇷🇺", name: "Игорь",      city: "Қазан",        amt: 760  },
    ...
    return _e("div", { className: "hh-live-card hh-glass",
      ...
      _e("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" } },
        _e("span", { style: { fontSize: 12, fontWeight: 700, letterSpacing: "0.10em", textTransform: "uppercase", color: "#a1a0a4" } }, "Жеке кабинет"),
      ...
      _e("div", { style: { padding: "20px 22px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" } },
        _e("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 } },
          _e("div", null,
            _e("div", { style: { fontSize: 10, color: "#a1a0a4", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", marginBottom: 8 } }, "Бір айда табылған"),
            ...
            _e("div", { style: {
              ...
              _e("span", { style: { fontSize: 12, lineHeight: 1 } }, "↑"), "айына +18%"
            )
          ),
        ...
        _e("div", { style: { marginTop: 20 } },
          _e("div", { style: { display: "flex", justifyContent: "space-between", fontSize: 11, color: "#a1a0a4", marginBottom: 8 } },
            _e("span", null, "5-деңгей · ", _e("span", { style: { color: "#fcd535", fontWeight: 700 } }, "70%")),
            _e("span", null, "6-деңгейге дейін · 75%")
          ),
      ...
      _e("div", { style: { padding: "18px 22px" } },
        _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 12 } }, "Серіктестерге соңғы төлемдер"),
        ...
        _e("div", { style: { marginTop: 14, paddingTop: 14, borderTop: "1px solid rgba(255,255,255,0.05)" } },
          _e("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 } },
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase", color: "#a1a0a4" } }, "Төлемдер географиясы"),
            _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 5, padding: "3px 9px", borderRadius: 100, background: "rgba(252,213,53,0.08)", border: "1px solid rgba(252,213,53,0.25)", color: "#fcd535", fontSize: 10, fontWeight: 800, letterSpacing: "0.08em" } }, "154 ЕЛ")
          ),
          _e("div", { className: "hh-flag-grid", style: { display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" } },
            ...
            _e("span", { style: { fontSize: 12, color: "#a1a0a4", marginLeft: 4 } }, "+ тағы 138")
          )
        )
      )
    );
    ...
    return _e("section", {
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 2 } },
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            _e("span", {
              ...
              "Hash Hedge серіктестік бағдарламасы"
            ),
            _e("h1", { className: "hh-partner-hero-h1",
              ...
              "жарнамала да,", _e("br", null),
              _e("span", { style: { color: "#fcd535" } }, "бізбен бірге", _e("br", null), "табыс тап")
            ),
            _e("p", { className: "hh-partner-hero-sub", style: {
              fontSize: 20, color: "#cfcfd3", lineHeight: 1.45,
              marginBottom: 36, maxWidth: 560
            } },
              "Әр тартқан трейдеріңнен ",
              _e("strong", { style: { color: "#f5f1e8", fontWeight: 800 } }, "80%-ға дейін комиссия"),
              " ал. Өмір бойы есептеулер, ашық статистика және жылдам төлемдер."
            ),
        ...
        _e("div", { className: "hh-partner-hero-stats", style: {
          ...
          _e("div", null,
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 8, whiteSpace: "nowrap" } }, "Сенімге ие платформамен серіктес бол"),
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Funded-трейдерлер")
          ),
          // $12M+
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Трейдерлерге төленді")
          ),
          // 4.4/5
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Қызмет көрсетілетін елдер")
          )
        )
      )
    );
  ...
  function AboutProgram() {
    const cards = [
      { label: "Тұрақты табыс", t: "Hash Hedge пайдасының 80%-ына дейін", b: "Әр сатып алудан Hash Hedge пайдасының 80%-ына дейін ал. Реферал саған өмір бойы бекітіледі: бір рет әкелсең, келесі барлық сатып алулардан комиссия аласың." },
      { label: "Пассивті табыс", t: "Табысты трейдерлерден түсетін кіріс", b: "Сен тартқан трейдер пайдасын шығарған сайын Hash Hedge комиссиясынан пайыз алып отыр." },
      { label: "Серіктестік желі", t: "Суб-серіктестік бағдарлама", b: "Басқа серіктестерді шақырып, олардың пайдасынан пайыз ал. Тікелей өзің тартқан серіктестер табысының 5%-ы және олар тартқан суб-серіктестерден 3%." }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Индустриядағы ең үздік", _e("br", null),
                "серіктестік ", _e("span", { style: { color: "#fcd535" } }, "шарттар.")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "Hash Hedge крипто-трейдерлерге сауда үшін ", _e("strong", { style: { color: "#f5f1e8", whiteSpace: "nowrap" } }, "$150 000"),
              " дейін капитал береді. Hash Hedge жарнамала, рефералдар әкел және проп-компаниялар арасындағы ең жомарт шарттармен бізбен бірге табыс тап."
            )
          )
        ),
  ...
  function Marquee() {
    ...
    const stats = [
      ...
      {
        v: "$2.5M+", l: "серіктестерге төленді",
        // wallet/dollar
        icon: _e(F, null,
  ...
  function WhyPartner() {
    ...
    const V1 = () => isMobile
      ? _e("div", { className: "hh-v1 hh-v1-mobile", style: { width: "100%", textAlign: "center", padding: "0 4px", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" } },
          _e("div", { style: { fontSize: 38, fontWeight: 900, color: "#fcd535", lineHeight: 1, letterSpacing: "-0.03em" } }, "80%-ға дейін"),
          _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6, fontWeight: 600 } }, "серіктеске")
        )
      : _e("div", { className: "hh-v1", style: { width: "100%", padding: "0 8px" } },
      _e("div", { className: "hh-v1-eyebrow", style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", color: "#a1a0a4", textTransform: "uppercase", marginBottom: 14, textAlign: "center" } }, "Серіктес комиссиясы"),
      _e("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 14 } },
        _e("div", { style: { display: "grid", gridTemplateColumns: "100px 1fr 50px", gap: 10, alignItems: "center" } },
          _e("span", { style: { fontSize: 13, color: "#f5f1e8", fontWeight: 600 } }, "Серіктес"),
      ...
      _e("div", { className: "hh-v1-competitors", style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", marginTop: 6, background: "rgba(8,8,10,0.5)", borderRadius: 8, borderTop: "1px dashed var(--line)" } },
        _e("span", { style: { fontSize: 11, color: "#a1a0a4" } }, "Бәсекелестер төлейді"),
    ...
    const V2 = () => isMobile
      ...
      [
        { l: "1-апта", v: "+$240", w: "60px" },
        { l: "2-апта", v: "+$280", w: "60px" },
        { l: "3-апта", v: "+$310", w: "60px" },
        { l: "әрқашан", v: "∞", w: "60px", inf: true }
    ...
    const V7 = () => isMobile
      ...
      _e("div", { style: { fontSize: 11, color: "#9ef0c0", marginTop: 10, display: "inline-flex", alignItems: "center", gap: 6 } },
        ...
        "Промокод қолданылды · 15% жеңілдік"
      )
    );
    ...
    const V8 = () => isMobile
      ? _e("div", { className: "hh-viz hh-viz-8",
          ...
          _e("div", { style: { padding: "4px 8px", background: "rgba(8,8,10,0.55)", border: "1px solid var(--line)", borderRadius: 6, display: "flex", justifyContent: "space-between", alignItems: "center" } },
            _e("span", { style: { fontSize: 7, color: "#a1a0a4", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Дереккөз"),
            _e("span", { style: { fontSize: 11, fontWeight: 700, color: "#f5f1e8" } }, "YouTube")
          ),
          _e("div", { style: { padding: "4px 8px", background: "rgba(8,8,10,0.55)", border: "1px solid var(--line)", borderRadius: 6, display: "flex", justifyContent: "space-between", alignItems: "center" } },
            _e("span", { style: { fontSize: 7, color: "#a1a0a4", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Кликтер"),
          ...
          _e("div", { style: { padding: "4px 8px", background: "rgba(252,213,53,0.06)", border: "1px solid rgba(252,213,53,0.3)", borderRadius: 6, display: "flex", justifyContent: "space-between", alignItems: "center" } },
            _e("div", { style: { display: "flex", flexDirection: "column" } },
              _e("span", { style: { fontSize: 7, color: "#a1a0a4", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Арнадан түскен табыс"),
      ...
      : _e("div", { className: "hh-viz hh-viz-8",
          ...
          _e("div", { style: { padding: "8px 10px", background: "rgba(252,213,53,0.06)", border: "1px solid rgba(252,213,53,0.3)", borderRadius: 6 } },
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 } },
              _e("span", { style: { fontSize: 8, color: "#a1a0a4", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Арнадан түскен табыс"),
              _e("span", { style: { fontSize: 9, color: "#4ade80", fontWeight: 700 } }, "↑ +34%")
            ),
    ...
    const V9 = () => _e("div", { style: { width: "100%", padding: 0, position: "relative" } },
      _e("svg", { width: "100%", height: 180, viewBox: "0 0 220 130", style: { display: "block" } },
        ...
        _e("text", { x: 110, y: 33, textAnchor: "middle", style: { fontSize: 11, fontWeight: 800, fill: "#13111c" } }, "МЕН"),
    ...
    const cards = [
      { viz: _e(V1, null), chip: "Проп-индустриядағы максимум", title: "Hash Hedge пайдасының 80%-ына дейін", titleAccent: "before",
        body: "Проп-индустриядағы ең үлкен комиссия. Басқа фирмалар әкелген клиент үшін 8–20% төлеп жатқанда, Hash Hedge-те сен компания пайдасының 50-ден 80%-ына дейінін аласың." },
      { viz: _e(V2, null), chip: "Бір трейдер = мәңгілік табыс", title: "Өмір бойы есептеулер", titleAccent: "before",
        body: "Трейдер саған мәңгілікке бекітіледі. Оның әр сатып алуынан комиссия аласың." },
      { viz: _e(V3, null), chip: "Биржа офферлерінен тиімдірек", title: "Биржалардан көбірек пайда",
        body: "$25–50k шоттағы бір funded-трейдер стандартты биржа рефералынан 5–10 есе көп табыс әкеледі." },
      { viz: _e(V4, null), chip: "72 сағат ішінде шығару", title: "Жылдам төлемдер", titleAccent: "before",
        body: "USDT-те шығаруды кез келген сәтте сұра. Ақша әмияныңа 72 сағат ішінде түседі." },
      { viz: _e(V5, null), chip: "Автоматты түрде өсесің", title: "Серіктестіктің 7 деңгейі", titleAccent: "before",
        body: "Қанша көп реферал тартсаң, комиссияң сонша жоғары." },
      // Карточка "Трафик из 154 стран" скрыта — чтобы сетка 4+4 без orphan
      // === 3 новые карточки ===
      { viz: _e(V7, null), chip: "Аудиторияға жеңілдіктер", title: "Аудиторияға арналған промокодтар", titleAccent: "before",
        body: "Конверсияны арттырып, сілтемең арқылы сатып алуды ынталандыру үшін жазылушыларыңа жеке жеңілдіктер ал." },
      { viz: _e(V8, null), chip: "Трафик аналитикасы", title: "Икемді трекинг",
        body: "Трафикті бөлу үшін кастом сілтемелер жасап, конверсияларды серіктестік жеке кабинетте қадағала." },
      { viz: _e(V9, null), chip: "Көпдеңгейлі желі", title: "Суб-серіктестік",
        body: "Өз сілтемең арқылы басқа аффилиаттарды тартып, көпдеңгейлі серіктестік желіден табыс тап." }
    ];
            ...
            _e("h2", { className: "hh-why-h2", style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } },
              isMobile
                ? _e(F, null,
                    "Неліктен", _e("br", null),
                    "біздің", _e("br", null),
                    _e("span", { style: { color: "#fcd535" } }, "серіктесіміз"), " болуың керек"
                  )
                : _e(F, null, "Неліктен біздің", _e("br", null), _e("span", { style: { color: "#fcd535" } }, "серіктесіміз"), " болуың керек")
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Серіктестерге бізбен бірге өсу үшін бәрін береміз.")
          )
        ),
  ...
  function IncomeSources() {
    ...
    const sources = [
      { n: "01", title: "Hash Hedge пайдасының 80%-ына дейін",
        body: _e(F, null, "Әр сатып алудан Hash Hedge пайдасының ", _e("b", { style: { color: "#fcd535" } }, "80%-ына дейінін"), " ал. Реферал саған өмір бойы бекітіледі: бір рет әкелсең, келесі барлық сатып алулардан комиссия аласың."),
        pill: "Тұрақты табыс",
        icon: ["M23 6l-9.5 9.5-5-5L1 18", "M17 6h6v6"] },
      { n: "02", title: "Табысты трейдерлерден түсетін кіріс",
        body: _e(F, null, "Сен тартқан трейдер пайдасын шығарған сайын Hash Hedge комиссиясынан пайыз алып отыр."),
        pill: "Пассивті табыс",
        icon: ["M12 6v6l4 2", "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z"] },
      { n: "03", title: "Суб-серіктестік бағдарлама",
        body: _e(F, null, "Басқа серіктестерді шақырып, олардың пайдасынан пайыз ал. ", _e("b", { style: { color: "#fcd535" } }, "5%"), " — тікелей өзің тартқан серіктестер табысынан, ", _e("b", { style: { color: "#fcd535" } }, "3%"), " — олар тартқан суб-серіктестерден."),
        pill: "Серіктестік желі",
        ...
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 760, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } },
              "Серіктес табысы ", _e("br", null), "қалай ", _e("span", { style: { color: "#fcd535" } }, "қалыптасады")
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Серіктестік сілтемең бірден үш көзден табыс әкеле алады.")
          )
        ),
    ...
    return _e("section", { id: "levels", style: { padding: "100px 0 120px", background: "var(--bg)" } },
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 880, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(34px, 4.5vw, 52px)", lineHeight: 1.08, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } },
              "Трейдер неғұрлым көп болса —", _e("br", null), "комиссияң соғұрлым жоғары"
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Трейдерлерді тартып, Hash Hedge пайдасының 80%-ына дейінін ал.")
          )
        ),
        ...
        _e("div", { className: "hh-bp-wrap", style: {
            ...
            _e("div", { className: "hh-bp-track-inner", style: {
              ...
              tiers.map((t, i) => {
                ...
                return _e("button", { key: t.lvl, type: "button",
                  ...
                  "aria-label": `${t.lvl}-деңгей ${t.label}, комиссия ${t.pct}%`,
                  style: {
                  ...
                  _e("div", { style: { fontSize: 11, color: "#52525a", marginTop: 3, fontWeight: 500 } }, "трейдер/ай")
                );
              })
            )
          ),
          ...
          } }, "Кез келген деңгейді бас →  толығырақ көр")
        ),
        ...
        _e("div", { className: "hh-bp-detail", style: {
          ...
          _e("div", { style: { minWidth: 0 } },
            ...
            _e("div", { className: "hh-bp-detail-line", style: { fontSize: 24, fontWeight: 800, color: "#f5f1e8", letterSpacing: "-0.01em", lineHeight: 1.25 } },
              ...
              _e("span", { style: { color: "#a1a0a4", fontWeight: 700, fontSize: 19 } }, " трейдер болғанда")
            )
          ),
          // CTA
        ...
        _e("div", { style: { textAlign: "center", fontSize: 13, color: "#a1a0a4" } },
          "Деңгей әр ай сайын тартылған трейдерлер санына қарай автоматты түрде қайта есептеледі"
        )
      )
    );
  }
  ...
  function Calculator() {
    const tiers = [
      { lvl: 1, pct: 50, min: 0,   max: 14,  range: "0–14 трейдер" },
      { lvl: 2, pct: 55, min: 15,  max: 49,  range: "15–49 трейдер" },
      { lvl: 3, pct: 60, min: 50,  max: 99,  range: "50–99 трейдер" },
      { lvl: 4, pct: 65, min: 100, max: 199, range: "100–199 трейдер" },
      { lvl: 5, pct: 70, min: 200, max: 399, range: "200–399 трейдер" },
      { lvl: 6, pct: 75, min: 400, max: 699, range: "400–699 трейдер" },
      { lvl: 7, pct: 80, min: 700, max: 999, range: "700+ трейдер" }
    ];
      ...
      _e("div", { className: "container" },
          ...
          _e("div", { className: "hh-calc-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { className: "hh-calc-h2", style: { fontSize: "clamp(32px, 4vw, 48px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Реферал неғұрлым көп болса,", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "комиссияң соғұрлым жоғары")
              )
            ),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "Трейдерлерді тартып, Hash Hedge пайдасының ",
              _e("strong", { style: { color: "#f5f1e8" } }, "80%"),
              "-ына дейінін ал. Қанша таба алатыныңды білу үшін пайда калькуляторын қолдан."
            )
          )
        ),
        ...
        _e("div", { className: "hh-calc-grid", style: {
          ...
          _e("div", { className: "hh-calc-card", style: {
            ...
            _e("div", { style: { fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a7a80", marginBottom: 24 } }, "Пайда калькуляторы"),
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 } },
              _e("div", { style: { fontSize: 14, color: "#a1a0a4" } }, "Белсенді тартылған трейдерлер"),
            ...
            _e("div", { style: { display: "flex", gap: 12, marginTop: 28 } },
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Сенің комиссияң"),
                _e("div", { style: { fontSize: 26, fontWeight: 800, color: "#fcd535", lineHeight: 1, fontFamily: "Onest, sans-serif" } }, currentTier.pct + "%"),
                _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, currentTier.lvl + "-деңгей")
              ),
              _e("div", { style: {
                flex: 1,
                padding: "16px 18px",
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Орт. / трейдер / ай"),
                _e("div", { style: { fontSize: 26, fontWeight: 800, color: "#f5f1e8", lineHeight: 1, fontFamily: "Onest, sans-serif" } }, "$" + AVG_PER_TRADER),
                _e("div", { style: { fontSize: 12, color: "#6b6a70", marginTop: 6 } }, "Платформа түсімі")
              )
            ),
            _e("div", { style: { marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--line)" } },
              _e("div", { style: { fontSize: 13, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 } }, "Ай сайынғы төлем"),
              ...
              _e("p", { style: { fontSize: 11, color: "#6b6a70", lineHeight: 1.5, margin: "18px 0 0" } },
                "Есеп шамамен берілген. Нақты табыс трейдерлердің белсенділігі мен аккаунттарының көлеміне байланысты."
              )
            )
          ),
          ...
          _e("div", { className: "hh-calc-levels", style: { display: "flex", flexDirection: "column", gap: 10, height: "100%" } },
            tiers.map(t => {
              ...
              return _e("button", { key: t.lvl, type: "button",
                ...
                "aria-label": `${t.lvl}-деңгейге өту: ${t.pct}%, ${t.range}`,
                ...
                _e("div", { style: { flex: 1, minWidth: 0, marginLeft: 16, position: "relative", zIndex: 1 } },
                  _e("div", { className: "hh-calc-tier-name", style: { fontSize: 13, fontWeight: 700, color: "#a1a0a4" } }, t.lvl + "-деңгей"),
  ...
  function Steps() {
    const steps = [
      { n: "01", chip: "Тіркелу",          title: "Тіркел",
        body: _e(F, null, "Қысқа сауалнаманы толтырып, серіктестің жеке кабинетіне қол жеткіз — бұл ", _e("b", { style: { color: "#f5f1e8", fontWeight: 800 } }, "2 минуттан"), " аз уақыт алады.") },
      { n: "02", chip: "Реферал сілтеме",  title: "Реферал сілтемеңді ал",
        body: "Жеке кабинетте жеке реферал сілтемеңді ал." },
      { n: "03", chip: "Жарнамалау",       title: "Трейдерлерді тарт",
        body: "Сілтемені әлеуметтік желілерде, Telegram-арналарда, YouTube-те, блогтарда немесе жеке ұсыныстарда бөліс." },
      { n: "04", chip: "Табыс",            title: "Төлемдерді ал",
        body: "Тартылған трейдерлер үшін Hash Hedge пайдасының 80%-ына дейінін ал. Төлемдер USDT-те 72 сағат ішінде." }
    ];
        ...
        _e(Reveal, null,
          _e("div", { className: "hh-steps-head", style: { display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 60, alignItems: "end", marginBottom: 56 } },
            _e("h2", { style: { fontSize: "clamp(40px, 5.5vw, 64px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", margin: 0 } },
              "Төрт қадам — ", _e("br", null), _e("span", { style: { color: "#fcd535" } }, "алғашқы пайдаға дейін")
            ),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } }, "Hash Hedge-пен бірге қазірдің өзінде табыс тауып жатқан 2500+ серіктеске қосыл.")
          )
        ),
  ...
  function CabinetPreview() {
    ...
    const cabKpis = useMemo(() => {
      ...
      return [
        ...
        { k: "Барлық сатып алулар", v: "$" + (48920 + tick * 320).toLocaleString("ru-RU").replace(/,/g, " "), d: "+18,4%", ic: "M3 3h2l.4 2 M7 13h10l4-8H5.4 M7 13L5.4 5 M7 13l-1.7 4.5h13.4 M9 21a1 1 0 1 0 0-2 1 1 0 0 0 0 2z M17 21a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" },
        { k: "Сатып алулар саны", v: String(312 + Math.floor(tick * 0.4)),                                  d: "+24",    ic: "M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z M3.27 6.96L12 12.01l8.73-5.05 M12 22.08V12" },
        { k: "Тіркелулер",        v: (1284 + tick * 3).toLocaleString("ru-RU").replace(/,/g, " "),         d: "+61",    ic: "M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M20 8v6 M23 11h-6" },
        { k: "Серіктес комиссиясы",  v: "$" + (34244 + tick * 180).toLocaleString("ru-RU").replace(/,/g, " "), d: "+21,7%", ic: "M12 2v20 M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" }
      ];
    }, [cabTick]);
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { className: "hh-cab-head", style: { display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 60, alignItems: "end", marginBottom: 40 } },
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(40px, 5.5vw, 64px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", margin: 0 } },
                "Барлық ", _e("span", { style: { color: "#fcd535" } }, "аналитика"), _e("br", null), "бір жерде"
              )
            ),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "Табысты, көрсеткіштерді және суб-серіктестер белсенділігін нақты уақытта бақыла."
            )
          )
        ),
              ...
              _e("div", { style: { display: "flex", alignItems: "center", gap: 14 } },
                _e("div", { style: { display: "flex", alignItems: "center", gap: 10 } },
                  ...
                  _e("div", { style: { lineHeight: 1.15 } },
                    ...
                    _e("div", { style: { fontSize: 9, fontWeight: 800, letterSpacing: "0.1em", color: "#a1a0a4" } }, "СЕРІКТЕСТІК ОРТАЛЫҚ")
                  )
                ),
                _e("div", { className: "hh-cab-greet", style: { lineHeight: 1.3, paddingLeft: 14, borderLeft: "1px solid var(--line)" } },
                  _e("div", { style: { fontSize: 14, fontWeight: 800, color: "#f5f1e8" } }, "Сәлем, Серіктес!"),
                  _e("div", { style: { fontSize: 11, color: "#a1a0a4" } }, "Қайта оралуыңмен, сені қайта көргенімізге қуаныштымыз!")
                )
              ),
              _e("div", { className: "hh-cab-top-right", style: { display: "flex", alignItems: "center", gap: 10 } },
                _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10, padding: "6px 12px", border: "1px solid rgba(74,222,128,0.4)", borderRadius: 100, background: "rgba(8,8,10,0.5)" } },
                  ...
                  _e("div", { style: { lineHeight: 1.2 } },
                    ...
                    _e("div", { style: { fontSize: 10, color: "#a1a0a4" } }, "Сенің жеке менеджерің")
                  )
                ),
            ...
            _e("div", { className: "hh-cab-body", style: { display: "grid", gridTemplateColumns: "230px 1fr", minHeight: 600 } },
              ...
              _e("div", { className: "hh-cab-side", style: { borderRight: "1px solid var(--line)", padding: "18px 12px" } },
                [
                  { title: "Аналитика", items: [
                    ...
                    { l: "Жалпы статистика", ic: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z M2 12h20" },
                    { l: "Толық есептер", ic: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6" },
                    { l: "Суб-серіктестер", ic: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2 M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z M22 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75" },
                    { l: "Лидерборд", ic: "M8 21h8 M12 17v4 M7 4h10v5a5 5 0 1 1-10 0V4z" }
                  ]},
                  { title: "Басқару", items: [
                    { l: "Серіктестік сілтемелер", ic: "M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71 M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" },
                    { l: "Постбэктер", ic: "M3 12h18 M12 3l9 9-9 9" }
                  ]},
                  { title: "Транзакциялар", items: [
                    { l: "Қаражатты шығару", ic: "M21 12H7 M14 5l7 7-7 7" }
                  ]},
                  { title: "Басқа", items: [
                    { l: "Тіл", ic: "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z M2 12h20 M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" },
                    { l: "Серіктестік келісім", ic: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6" }
                  ]}
              ...
              _e("div", { className: "hh-cab-main", style: { padding: 22 } },
                ...
                _e("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 18px", background: "rgba(255,255,255,0.025)", border: "1px solid var(--line)", borderRadius: 12, marginBottom: 24 } },
                  _e("div", { style: { fontSize: 14, fontWeight: 700, color: "#f5f1e8" } }, "Серіктестік сілтемелер"),
        ...
        _e(Reveal, { delay: "3" },
          _e("div", { className: "hh-cab-explainers", style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 } },
            [
              { paths: ["M22 12h-4l-3 9L9 3l-3 9H2"], t: "Нақты уақыттағы аналитика", b: "Кликтер, тіркелулер, сатып алулар және комиссиялар автоматты түрде жаңарады." },
              { paths: ["M22 11.08V12a10 10 0 1 1-5.93-9.14", "M22 4L12 14.01l-3-3"], t: "Суб-серіктестер статистикасы", b: "Барлық деңгейдегі есептеулерді бақыла: тікелей серіктестерің мен олардың рефералдары." },
              // Lucide "wallet" — чистая иконка кошелька с застёжкой, ассоциируется с выводом средств
              { paths: ["M21 12V7H5a2 2 0 0 1 0-4h14v4", "M3 5v14a2 2 0 0 0 2 2h16v-5", "M18 12a2 2 0 0 0 0 4h4v-4Z"], t: "Кез келген сәтте шығару", b: "USDT-тегі төлемдерді белгіленген күндерсіз сұра." },
              { paths: ["M12 20h9", "M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"], t: "Икемді құралдар", b: "Сілтемелер мен промокодтар жасап, постбэктерді бірнеше секундта қос." }
          ...
          _e("div", { className: "hh-lb-head", style: { display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 60, alignItems: "end", marginBottom: 40 } },
            _e("div", null,
              _e("span", {
                ...
                _e("span", { style: { width: 6, height: 6, borderRadius: "50%", background: "#4ade80", boxShadow: "0 0 8px #4ade80" } }),
                "Нақты уақытта жаңарады"
              ),
              _e("h2", { style: { fontSize: "clamp(40px, 5.5vw, 64px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", margin: 0 } },
                "Топ серіктестер", _e("br", null), _e("span", { style: { color: "#fcd535" } }, "осы айда")
              )
            ),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "Рефералдар тартып, топқа шық. Лидерборд айына ең жоғары табыс тапқан серіктестерді нақты уақытта көрсетеді."
            )
          )
        ),
        _e(Reveal, { delay: "1" },
          _e("div", { style: { background: "rgba(255,255,255,0.02)", border: "1px solid var(--line)", borderRadius: 18, overflow: "hidden" } },
            ...
            _e("div", { style: { padding: "26px 32px 18px" } },
              _e("h3", { style: { fontSize: 22, fontWeight: 800, color: "#f5f1e8", margin: 0, letterSpacing: "-0.01em" } }, "Топ серіктестер")
            ),
            // Column headers
            _e("div", { className: "hh-lb-row hh-lb-head-row",
              ...
              ["Ранг", "Серіктес", "Сатып алу сомасы"].map((h, i) => _e("div", { key: i,
            ...
            _e("div", { style: { padding: "14px 32px", fontSize: 11, color: "#a1a0a4", display: "flex", justifyContent: "space-between", borderTop: "1px solid var(--line)", flexWrap: "wrap", gap: 12 } },
              _e("span", { style: { display: "inline-flex", alignItems: "center", gap: 6 } },
                _e("span", { style: { width: 6, height: 6, borderRadius: "50%", background: "#4ade80" } }), "Жаңа ғана жаңартылды"
              ),
              _e("span", null, "Топ-5 ай қорытындысы бойынша бекітіледі · аттар құпиялылық үшін жасырылған")
            )
          )
        )
      )
  ...
  function PartnerContent() {
    ...
    const videos = [
      { id: "v70Cj06fueA", title: "1-фазалық челленджден қалай өту керек",                                   author: "@trader_oleg", views: "73K"  },
      { id: "xJ4yA5MDMDU", title: "Funded-трейдермен сұхбат",                                                author: "@yariktrade",  views: "112K" },
      { id: "IlSjDtqwwuA", title: "Hash Hedge челленджіне шолу",                                             author: "@cryptopro",   views: "94K"  },
      { id: "PUAyUaSommg", title: "$49-дан $5 580-ге дейін — крипто-проп-трейдингпен өмірді қалай өзгертуге болады", author: "Хедлайнеры | Никита Ануфриев", views: "127K" },
      { id: "oz_72s2S5Xc", title: "Платформа мен шарттарды талдау",                                          author: "@cryptoschool",views: "41K"  },
      { id: "lnsWjuJuguE", title: "Челлендждегі сауда стратегиясы",                                          author: "@cryptopro",   views: "67K"  }
    ];
          ...
          _e("div", { className: "hh-yt-head", style: { display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 60, alignItems: "end", marginBottom: 40 } },
            _e("div", null,
              _e("span", {
                ...
                _e("span", { style: { width: 6, height: 6, borderRadius: "50%", background: "#4ade80", boxShadow: "0 0 8px #4ade80" } }),
                "Серіктестер контенті"
              ),
              _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.08, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", margin: 0 } },
                "Серіктестерге табыс табуға", _e("br", null), _e("span", { style: { color: "#fcd535" } }, "не көмектеседі")
              )
            ),
            _e("p", { style: { fontSize: 15, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "2500+ серіктестің контент жасап, клиенттерді қалай тартатынын көр. Шабыт алып, үздік механикаларды өз контентіңде қолдан."
            )
          )
        ),
          ...
          _e(Reveal, { delay: "1" },
            _e("a", {
              ...
              _e("div", { style: { position: "relative", aspectRatio: "16/9", background: `url(https://img.youtube.com/vi/${hero.id}/maxresdefault.jpg) center / cover, #111`, flexShrink: 0 } },
                _e(PlayBtn, { size: 72 }),
                _e("div", { style: { position: "absolute", top: 14, left: 14, display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 11px", borderRadius: 100, background: "rgba(8,8,10,0.78)", backdropFilter: "blur(10px)", border: "1px solid rgba(255,255,255,0.12)", fontSize: 11, fontWeight: 700, color: "#fcd535", letterSpacing: "0.08em", textTransform: "uppercase" } }, "★ Қаралым хиті")
              ),
              _e("div", { style: { padding: "22px 24px 24px", flex: 1 } },
                _e("div", { style: { fontSize: 12, fontWeight: 700, color: "#fcd535", letterSpacing: "0.06em", marginBottom: 10 } }, hero.author + " · " + hero.views + " қаралым"),
  ...
  function Events() {
    ...
    const events = [
      // [0] = hero big
      { flag: "🇦🇪", city: "Дубай",     year: "Қазан 2025", role: "Ұйымдастырушы", title: "WSCT 2025-тен кейінгі серіктестік кездесу",     img: "https://hash-hedge-partner.vercel.app/assets/event-dubai.jpg" },
      // [1], [2] = stacked справа
      { flag: "🇦🇪", city: "Дубай",     year: "2025",          role: "Демеуші",      title: "Blockchain Live 2025-тегі серіктестер",     img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/event-blockchain-forum.jpg" },
      { flag: "🇧🇷", city: "Сан-Паулу", year: "2025",          role: "Ұйымдастырушы", title: "WSCT Бразилия · Офлайн турнир",   img: "https://hash-hedge-partner.vercel.app/assets/event-saopaulo.jpeg" },
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "Мәскеу",    year: "2026",          role: "Ұйымдастырушы",  title: "Серіктестік кешкі ас",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "Мәскеу",    year: "2026",          role: "Ұйымдастырушы", title: "Топ-серіктестерді марапаттау",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇦🇪", city: "Дубай",     year: "2025",          role: "Hash Hedge амбассадоры", title: "Никита Ануфриев",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇦🇪", city: "Дубай",     year: "2025",          role: "Ұйымдастырушы",  title: "Серіктестік кездесу",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
        ...
        _e("div", { className: "hh-events-head", style: { display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 60, alignItems: "end", marginBottom: 48 } },
          _e(Reveal, null,
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(40px, 5.5vw, 64px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", margin: 0 } },
                _e("span", { style: { color: "#fcd535" } }, "Жанды"), " кездесулер"
              )
            )
          ),
          _e(Reveal, { delay: "2" },
            _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "Hash Hedge серіктестік қауымдастығының бір бөлігі бол. Біз үнемі офлайн-ивенттер өткіземіз: онда басқа топ-серіктестермен танысып, тәжірибе алмасып, жақсылап демалуға болады."
            )
          )
        ),
  ...
  function TelegramCommunity() {
    ...
    const channelsBase = [
      { ic: "#",  name: "Жаңалықтар 📩",    sub: "Серіктестің жаңа жеке кабинеті…",      time: "СС",     pinned: true },
      { ic: "🎬", name: "Контент",          sub: "Queen Prop: Дайын, оқасы жоқ 😊",       time: "ЖС",     unread: 29 },
      { ic: "📣", name: "Серіктестер чаты", sub: "Достар, бәріңе сәлем! Еске саламыз…",  time: "ЖМ",     unread: 13 },
      { ic: "⚡", name: "Акциялар",         sub: "Hash Hedge-те Flash Sale: 28–29 мамыр", time: "БС",     unread: 6  },
      { ic: "📝", name: "Промо материалдар", sub: "сторис баннерлерін жаңарттық",        time: "қазір", unread: 1  }
    ];
    ...
    const tgScenes = [
      { activeIdx: 4, overrides: { 4: { sub: "сторис баннерлерін жаңарттық",                                   time: "қазір",  unread: 1 } } },
      { activeIdx: 2, overrides: { 2: { sub: "теріп жатыр…",                                                       time: "қазір",  unread: 0, subColor: "#5BB5E8" } } },
      { activeIdx: 2, overrides: { 2: { sub: "Мақсат · Алматы 🇰🇿: жаңа ғана Level 3-тен өтті 🔥",              time: "қазір",  unread: 1 } } },
      { activeIdx: 2, overrides: { 2: { sub: "Igor K.: керемет кейс — видео түсіру керек",                     time: "қазір",  unread: 2 } } },
      { activeIdx: 2, overrides: { 2: { sub: "теріп жатыр…",                                                       time: "қазір",  unread: 2, subColor: "#5BB5E8" } } },
      { activeIdx: 2, overrides: { 2: { sub: "Olga · Мәскеу: промо-материалдар үшін рахмет, алдым 🤝",          time: "қазір",  unread: 3 } } }
    ];
          ...
          _e(Reveal, null,
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 22 } },
                _e("span", { style: { color: "#2AABEE" } }, "Жабық чат"), _e("br", null),
                "серіктестерге арналған"
              ),
              _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, marginBottom: 32, maxWidth: 540 } },
                "Эксклюзивті промо-материалдар, арнайы акциялар және Hash Hedge командасымен тікелей байланыс. Тіркелгеннен кейін қолжетімді."
              ),
              _e("div", { style: { display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 14, marginBottom: 22 } },
                [
                  ["332+",    "Қатысушы"],
                  ["146",     "Қазір онлайн"],
                  ["<2 мин",  "Менеджер жауабы"],
                  ["24/7",    "Чат әрқашан ашық"]
              ...
              _e("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#a1a0a4", lineHeight: 1.5 } },
                ...
                "Жабық қауымдастық — қолжетімділік серіктес тіркелгеннен кейін менеджер арқылы ашылады"
              )
            )
          ),
                  ...
                  _e("div", { style: { padding: "16px 14px 12px", display: "grid", gridTemplateColumns: "44px 1fr 44px", gap: 8, alignItems: "center" } },
                    ...
                    _e("div", { style: { textAlign: "center" } },
                      ...
                      _e("div", { style: { fontSize: 12, color: "#7d8590" } },
                        "332 қатысушы, ", _e("span", { style: { color: "#4ade80" } }, "146 желіде")
                      )
                    ),
  ...
  function Support() {
    ...
    const features = [
      "Бір күн ішінде іске қосылуға көмектесеміз",
      "Hash Hedge-тен дайын маркетингтік материалдар береміз",
      "Аудиторияң үшін қай байламдар ең жақсы жұмыс істейтінін көрсетеміз",
      // v12.4: финальная фраза — без галочки, жирная 15px
      { strong: true, node: _e(F, null, "Біздің аффилиат-менеджерлермен серіктестер ", _e("b", { style: { color: "#fcd535", fontWeight: 800 } }, "бес таңбалы табысқа"), " шығады") }
    ];
          ...
          _e(Reveal, { delay: "2" },
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.04, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: "0 0 20px" } },
                "Қасыңдамыз", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "әр кезеңде")
              ),
              _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, marginBottom: 32 } },
                "Алғашқы күннен бастап сені жеке менеджер қолдап жүреді. Серіктестік қолдау жетекшісі Tati және оның командасы стратегияңды оңтайландырып, трафикті масштабтауға көмектеседі."
              ),
              ...
              _e("div", { style: { display: "flex", gap: 12, flexWrap: "wrap", maxWidth: 600 } },
                ...
                _e("a", { href: "https://t.me/hashhedge_affiliate", target: "_blank", rel: "noopener noreferrer",
                  ...
                  _e("span", { style: { color: "#fff" } }, "Қолдау қызметіне жазу")
                )
              )
            )
          )
  ...
  function FAQ() {
    const items = [
      { q: "Hash Hedge серіктестік бағдарламасы қалай жұмыс істейді?", a: "Бағдарлама RevShare моделі бойынша жұмыс істейді: реферал сілтемең арқылы әр челлендж сатып алудан компания пайдасының 50%-дан 80%-ына дейінін аласың. Есептеулер — өмір бойы, реферал белсенді болғанша." },
      { q: "«Компания пайдасы» деп не есептеледі?", a: "Пайда = челлендж құны − 21% (7% — төлем жүйесінің комиссиясы, 14% — резервтік қор). Мысалы, $499 тұратын Elite челленджінде база шамамен $394 — бастапқы 50% деңгейінде сен таза күйінде шамамен $197 аласың." },
      { q: "Менің RevShare пайызым қалай өседі?", a: "Барлық серіктестер 50%-дан бастайды. Әр айдың 1-і күні пайыз өткен айда рефералдарың сатып алған челлендждер санына қарай қайта есептеледі және келесі ай бойы сақталады. Максимум — айына 700+ сатылым кезінде 80%." },
      { q: "Трейдерлердің пайдасынан табыс таба аламын ба?", a: "Иә. Егер реферал челленджден өтіп, плюске сауда жасаса, ол пайданың 80%-ын алады, компания — 20%, ал сен осы 20%-дан өз RevShare пайызыңды аласың. Мысал: трейдер $10 000 тапты → компания $2 000 алады → саған $1 600-ге дейін." },
      { q: "Төлемдер қашан және қалай жасалады?", a: "Төлемді тікелей серіктестік кабинетте сұра — ол USDT-те әмияныңа 72 сағат ішінде түседі. Шығарудың минимумы — $100; алғашқы төлем сатып алу жасаған 5 рефералдан кейін қолжетімді." },
      { q: "Әкелген серіктестерден табыс бар ма?", a: "Иә, көпдеңгейлі бағдарлама: тікелей өзің әкелген серіктес табысынан 5% және келесі деңгейдегі серіктестен 3%. Бұл пайыздарды компания үстінен төлейді — суб-серіктестеріңнің табысы азаймайды." },
      { q: "Қатысу үшін трейдер болу керек пе?", a: "Жоқ. Серіктес кез келген адам бола алады — блогер, маркетолог, инфлюенсер немесе комьюнити иесі. Трейдинг тәжірибесі қажет емес, ал 154 елдің аудиториясымен жұмыс істеуге болады." },
      { q: "Қаражат шығаруға қандай лимиттер бар?", a: "Шығарудың минималды сомасы — $100. Алғашқы төлем 5 рефералың кемінде бір сатып алу жасағаннан кейін қолжетімді болады — бұл бағдарламаны өзін-өзі рефералдаудан қорғайды. Әрі қарай кабинеттен сұраныс бойынша шығара бер, жиілік шектеусіз." }
    ];
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "Жиі қойылатын сұрақтар"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "Серіктестік бағдарлама туралы білуің керектің бәрі.")
          )
        ),
        _e(Reveal, { delay: "1" },
          ...
          _e("div", { className: "hh-faq-cta",
            ...
            _e("div", { style: { flex: "1 1 320px", minWidth: 0 } },
              _e("div", { style: { fontSize: 22, fontWeight: 700, color: "#f5f1e8", marginBottom: 8 } },
                "Сұрақтарың ", _e("span", { style: { color: "#fcd535" } }, "қалды ма?")
              ),
              _e("div", { style: { fontSize: 14, color: "#a1a0a4", lineHeight: 1.5, margin: 0 } },
                "Telegram-дағы серіктестік қолдауға жаз — көмектесеміз және серіктестік бағдарлама бойынша барлық сұраққа жауап береміз."
              )
            ),
            _e("a", { href: "https://t.me/hashhedge_affiliate", target: "_blank", rel: "noopener noreferrer", className: "hh-btn-tg",
              ...
              _e("span", { style: { color: "#fff" } }, "Telegram-дағы қолдау")
            )
          )
        )
      )
          ...
          _e("div", {
            ...
            _e("div", { style: { position: "relative", zIndex: 1, textAlign: "center" } },
              ...
              _e("h2", { style: { fontSize: "clamp(38px, 5.6vw, 64px)", lineHeight: 1.08, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 28 } },
                _e("span", { style: { color: "#fcd535", textShadow: "0 0 36px rgba(252,213,53,0.45)" } }, "Hash Hedge"), _e("br", null),
                "серіктесі бол"
              ),
  ...
  function Footer() {
    const columns = [
      { t: "Өнім", l: [
        { label: "Челлендждер",             href: "https://www.hashhedge.com/kz#challenge" },
        { label: "Серіктестік бағдарлама",  href: "https://www.hashhedge.com/affiliateprogram/kz" },
        { label: "Блог",                    href: "https://www.hashhedge.com/blog/ru" },
        { label: "Нұсқаулық",               href: "https://hashhedge.gitbook.io/hashhedge-user-guide" }
      ]},
      { t: "Біз туралы", l: [
        { label: "Қолдау",      href: "https://t.me/hashhedgesupportbot" },
        { label: "FAQ",         href: "https://www.hashhedge.com/faq/ru" },
        { label: "Вакансиялар", href: "https://www.hashhedge.com/vacancies" }
      ]},
      { t: "Құжаттар", l: [
        { label: "Құпиялылық саясаты",     href: "https://www.hashhedge.com/privacy-policy" },
        { label: "Пайдалану шарттары",     href: "https://www.hashhedge.com/terms-and-conditions" },
        { label: "Коммерциялық шарттар",   href: "https://www.hashhedge.com/commercial-terms" },
        { label: "Серіктестік саясат",     href: "https://www.hashhedge.com/affiliate-politics" }
      ]}
    ];
    const partners = [
    ...
    return _e("footer", { style: { padding: "88px 0 64px", background: "var(--bg-elev)", borderTop: "1px solid var(--line)" } },
      _e("div", { className: "container", style: { maxWidth: 1180 } },
        _e("div", { className: "hh-footer-grid", style: { display: "grid", gridTemplateColumns: "1.25fr repeat(3, 1fr)", gap: 86, marginBottom: 92 } },
          _e("div", { style: { paddingTop: 4 } },
            ...
            _e("p", { style: { fontSize: 15, color: "var(--fg-low)", marginTop: 44, lineHeight: 1.45, maxWidth: 260 } },
              "Hash Hedge — проп-трейдинг платформасы: криптовалютамен және TradFi-активтермен сауда жаса. $150K дейінгі капиталды басқар."
            )
          ),
        ...
        _e("div", { className: "hh-footer-partners", style: { display: "flex", alignItems: "center", gap: 54, marginBottom: 116, flexWrap: "wrap" } },
          _e("div", { style: { fontSize: 14, fontWeight: 800, color: "rgba(238,238,243,0.8)" } }, "Біздің серіктестер"),
        ...
        _e("div", { style: { textAlign: "center" } },
          ...
          _e("p", { style: { fontSize: 12, lineHeight: 1.35, color: "rgba(238,238,243,0.36)", maxWidth: 1050, margin: "0 auto" } },
            "Бұл сайттағы барлық ақпарат тек қаржы нарықтарындағы саудамен танысуға арналған және ешбір жағдайда инвестициялық құралдармен сауда жасауға қатысты нақты инвестициялық, бизнес немесе өзге де ұсыныс болып табылмайды."
          )
        )
      )
    );
