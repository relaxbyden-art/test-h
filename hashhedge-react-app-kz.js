...
function Hero({
  ...
  }, "Challenge-тен өтіп, сауда жасаңыз ", /*#__PURE__*/React.createElement("br", {
...
function PromoBanner() {
  ...
  }, "10+ TradFi активтер"), " кез келген Challenge-те"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 16,
      lineHeight: 1.5,
      color: "var(--fg-muted)",
...
function HowItWorks() {
  ...
  }, "$150К-ге дейінгі капиталда өз сауда стратегияңызды жүзеге асырып, пайданың 90%-ға дейінін шығарыңыз."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
...
function Pricing() {
  ...
  }, "Өлшемді таңдаңыз ", /*#__PURE__*/React.createElement("span", {
    style: {
      color: "var(--accent)"
    }
  ...
  }, "Challenge-тен өтіп, пайданың 90%-ға дейінін шығарыңыз"))), /*#__PURE__*/React.createElement(Reveal, {
    delay: "2"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      maxWidth: 1112,
...
function WhyUs() {
  ...
  }, "Hash Hedge платформасы сіздің сауда стратегияңызды толық жүзеге асыруға және максималды пайда алуға арналған. Біз капиталды береміз, тәуекелдерді өзімізге аламыз және сауда жасауға жағдай жасаймыз."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gridTemplateColumns: "repeat(4, 1fr)",
      gap: 20
...
function YouTubeSection() {
  ...
  }, "YouTube-тағы Hash Hedge туралы бейнелерді көріңіз: Challenge-терден өту, төлемдерді растау және платформа туралы шынайы шолулар.")))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
...
function FAQ() {
  ...
  const items = [{
    ...
    a: /*#__PURE__*/React.createElement(React.Fragment, null, "Барлығы \u2014 Challenge сатып алудан пайданы шығаруға дейін \u2014 біздің ", /*#__PURE__*/React.createElement("a", {
      href: "https://hashhedge.gitbook.io/hashhedge-user-guide",
      target: "_blank",
      rel: "noopener",
      style: {
    ...
    q: "Неліктен Challenge үшін төлеу керек?",
    a: "Ақылы кіру сүзгі рөлін атқарады, ал Challenge-тің өзі іріктеу немесе емтихан қызметін атқарады. Қаржыландыру алғаннан кейін трейдерлер компанияның капиталында сауда жасайды және нақты ақшамен төлем алады. Challenge-тің негізгі мақсаты — шын мәнінде жүйелі сауда жасап, тұрақты пайда көрсете алатын трейдерлерді таңдау, бір сәтті мәміленің бір реттік нәтижесі емес."
  }, {
    q: "Challenge кезінде қандай ережелерді сақтау керек?",
    a: /*#__PURE__*/React.createElement(React.Fragment, null, "Күндік және максималды drawdown лимиттерін сақтап, белгіленген сауда күндері ішінде пайда мақсатына жету керек. Әр Challenge бойынша егжей-тегжейлер сатып алу бетінде және ", /*#__PURE__*/React.createElement("a", {
    ...
    a: "Challenge аяқталады. Бұл күндік және жалпы drawdown лимитіне де қатысты. Ашық позициялар бойынша іске аспаған шығындар да есепке алынады."
  }, {
    ...
    q: "Бір мезгілде бірнеше Challenge-ке қатысуға бола ма?",
    a: "Иә, Stage 1 және Stage 2-де бірнеше Challenge-ті қатар жүргізуге болады. Stage 3-те (Funded) \u2014 әр аккаунт өлшеміне тек бір Challenge."
  }, {
    q: "Challenge-тен өттім. Енді не?",
    a: "Сіз Funded аккаунт аласыз (жиынтық). Біздің капиталмен сауда жасайсыз, пайданың 90%-ын аласыз."
  }, {
    ...
    a: "Жоқ. Challenge үшін төлем \u2014 жалғыз төлем. Funded аккаунт қосымша төлемсіз белсендіріледі."
  }, {
  ...
  }, "Проп-фирманы таңдау және Challenge сатып алу алдында білу маңызды нәрсенің бәрі."))), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column",
      gap: 12
...
function Footer() {
  ...
  }, "Hash Hedge \u2014 проп-трейдинг платформасы: криптовалюта және TradFi активтерімен сауда жасаңыз. $150K-ға дейінгі капиталды басқарыңыз.")), columns.map(col => /*#__PURE__*/React.createElement("div", {
    key: col.t
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 18,
