(function(){
  ...
  function Header() {
    ...
    const nav = [
      { l: "Über",     h: "#about-program" },
      { l: "Funktionsweise",    h: "#how" },
      { l: "Verdienst",           h: "#calc" },
      { l: "FAQ",             h: "#faq" },
      { l: "Trading-Challenge", h: "https://hashhedge.com/", external: true }
    ];
    const langs = [
      { code: "EN", flag: "🇬🇧", label: "English",          href: "https://www.hashhedge.com/affiliateprogram" },
      { code: "DE", flag: "🇩🇪", label: "Deutsch",          href: "#", current: true },
  ...
  function HeroCandles() {
    ...
    return _e("div", { "aria-hidden": true, className: "hh-hero-candles",
      style: { position: "absolute", inset: 0, pointerVeranstaltungen: "none", zIndex: 0 }
    },
  ...
  function LivePartnerCard() {
    ...
    const payoutPool = [
      { flag: "🇷🇺", name: "Сергей",     city: "Moskau",       amt: 1850 },
    ...
    return _e("div", { className: "hh-live-card hh-glass",
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        pointerVeranstaltungen: "none", zIndex: 1, borderRadius: "26px 26px 0 0"
      } }),
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        opacity: 0.7, pointerVeranstaltungen: "none"
      } }),
      ...
      _e("div", { style: { padding: "20px 22px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" } },
        _e("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 } },
          _e("div", null,
            ...
            _e("div", { style: {
              ...
              _e("span", { style: { fontSize: 12, lineHeight: 1 } }, "↑"), "+18% this month"
            )
          ),
        ...
        _e("div", { style: { marginTop: 20 } },
          ...
          _e("div", { style: { position: "relative", height: 8, borderRadius: 6, background: "rgba(255,255,255,0.06)", overflow: "hidden", border: "1px solid rgba(255,255,255,0.04)" } },
            ...
            // Shimmer-полоска
            _e("div", { style: {
              position: "absolute", inset: "0 24% 0 0", borderRadius: 6, overflow: "hidden", pointerVeranstaltungen: "none"
            } },
              _e("div", { style: {
      ...
      _e("div", { style: { padding: "18px 22px" } },
        ...
        _e("div", { style: { marginTop: 14, paddingTop: 14, borderTop: "1px solid rgba(255,255,255,0.05)" } },
          ...
          _e("div", { className: "hh-flag-grid", style: { display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" } },
            ...
            _e("span", { style: { fontSize: 12, color: "#a1a0a4", marginLeft: 4 } }, "+ 138 more")
          )
        )
      )
    );
  ...
  function Hero() {
    ...
    // matrix-стене), большой H1 в 4 строки с акцентом на «verdiene mit», 2 CTA,
    // ссылка «Verdienst berechnen», блок Trustpilot снизу с 4-stat ряду.
    ...
    return _e("section", {
      ...
      _e("div", { "aria-hidden": "true", className: "hh-partner-hero-bg", style: {
        ...
        pointerVeranstaltungen: "none", zIndex: 0
      } }),
      ...
      _e("div", { "aria-hidden": "true", style: {
        ...
        pointerVeranstaltungen: "none", zIndex: 1
      } }),
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 2 } },
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            ...
            _e("h1", { className: "hh-partner-hero-h1",
              ...
              "Vermarkte ein Top", _e("br", null),
              "Krypto-Prop-Trading-Unternehmen", _e("br", null),
              "weltweit und", _e("br", null),
              _e("span", { style: { color: "#fcd535" } }, "verdiene mit")
            ),
            _e("p", { className: "hh-partner-hero-sub", style: {
              ...
              "Erhalte bis zu ",
              _e("strong", { style: { color: "#f5f1e8", fontWeight: 800 } }, "80% revenue share"),
              " für jeden geworbenen Trader — wöchentlich in USDT ausgezahlt, lebenslang."
            ),
        ...
        _e("div", { className: "hh-partner-hero-stats", style: {
          ...
          _e("div", null,
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 8, whiteSpace: "nowrap" } }, "Partnerchaft mit einer geprüften Plattform"),
            _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10 } },
              _e("span", { style: { fontSize: 16, fontWeight: 800, color: "#f5f1e8" } }, "Hervorragend"),
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Funded Trader weltweit")
          ),
          // $12M+
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "An Trader gezahlt")
          ),
          // 4.4/5
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Länder bedient")
          )
        )
      )
    );
  ...
  function AboutProgram() {
    const cards = [
      { v: "bis zu 80%", t: "vom HashHedge-Gewinn",         b: "Branchenführender Umsatzanteil pro geworbenem Trader." },
      { v: "Wöchentlich", t: "Zahlungen in USDT",            b: "Verdienst landet jeden Montag in deiner Wallet." },
      { v: "Lebenslang", t: "Vergütung",                 b: "Du verdienst, solange der Trader aktiv ist." },
      { v: "Minuten", t: "bis zur Freigabe",                   b: "Schnelle Freigabe, minimale Formalitäten, sofortiger Link." }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Die besten Affiliate-", _e("br", null),
                "Konditionen ", _e("span", { style: { color: "#fcd535" } }, "der Branche.")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "HashHedge gibt Krypto-Tradern ", _e("strong", { style: { color: "#f5f1e8" } }, "$5,000 to $100,000"),
              ", um risikofrei zu traden. Deine Aufgabe ist einfach — bring diese Trader an Bord. Im Gegenzug erhältst du einen Anteil am Umsatz, den sie generieren, zu den großzügigsten Konditionen, die eine Prop-Firma bietet."
            )
          )
        ),
          ...
          cards.map((c, i) => _e(Reveal, { key: i, delay: String((i % 4) + 1) },
            _e("div", { className: "hh-about-card", style: {
              ...
              _e("div", { style: {
                ...
                marginBottom: 12,
                fontFamily: "Onest, sans-serif",
                textTransform: c.v === "bis zu 80%" || c.v === "Minuten" || c.v === "Lebenslang" || c.v === "Wöchentlich" ? "none" : "uppercase"
              } }, c.v),
  ...
  function WhyPartner() {
    ...
    const V1 = () => isMobile
      ? _e("div", { className: "hh-v1 hh-v1-mobile", style: { width: "100%", textAlign: "center", padding: "0 4px", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" } },
          _e("div", { style: { fontSize: 38, fontWeight: 900, color: "#fcd535", lineHeight: 1, letterSpacing: "-0.03em" } }, "bis zu 80%"),
      ...
      _e("div", { className: "hh-v1-competitors", style: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 12px", marginTop: 6, background: "rgba(8,8,10,0.5)", borderRadius: 8, borderTop: "1px dashed var(--line)" } },
        _e("span", { style: { fontSize: 11, color: "#a1a0a4" } }, "Competitors pay"),
    ...
    const V3 = () => _e("div", { className: "hh-viz hh-viz-3",
      ...
      _e("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: isMobile ? 3 : 6 } },
        _e("div", { style: { padding: isMobile ? "3px 4px" : "6px 6px", background: "rgba(8,8,10,0.6)", border: "1px solid var(--line)", borderRadius: 6 } },
          _e("div", { style: { fontSize: isMobile ? 7 : 9, color: "#a1a0a4", marginBottom: 0, lineHeight: 1.1 } }, "Exchange"),
      ...
      ? _e("div", { className: "hh-viz hh-viz-8",
          ...
          _e("div", { style: { padding: "4px 8px", background: "rgba(252,213,53,0.06)", border: "1px solid rgba(252,213,53,0.3)", borderRadius: 6, display: "flex", justifyContent: "space-between", alignItems: "center" } },
            _e("div", { style: { display: "flex", flexDirection: "column" } },
              _e("span", { style: { fontSize: 7, color: "#a1a0a4", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Earnings from channel"),
      ...
      : _e("div", { className: "hh-viz hh-viz-8",
          ...
          _e("div", { style: { padding: "8px 10px", background: "rgba(252,213,53,0.06)", border: "1px solid rgba(252,213,53,0.3)", borderRadius: 6 } },
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 4 } },
              _e("span", { style: { fontSize: 8, color: "#a1a0a4", textTransform: "uppercase", letterSpacing: "0.08em" } }, "Earnings from channel"),
              _e("span", { style: { fontSize: 9, color: "#4ade80", fontWeight: 700 } }, "↑ +34%")
            ),
    ...
    // V9 — Mehrstufiges Netzwerk. Картинка увеличена (viewBox шире), круги с непрозрачным фоном.
    const V9 = () => _e("div", { style: { width: "100%", padding: 0, position: "relative" } },
      _e("svg", { width: "100%", height: 180, viewBox: "0 0 220 130", style: { display: "block" } },
        ...
        _e("text", { x: 110, y: 33, textAnchor: "middle", style: { fontSize: 11, fontWeight: 800, fill: "#13111c" } }, "DU"),
    ...
    const cards = [
      { viz: _e(V1, null), chip: "Top in the prop industry", title: "Bis zu 80% vom Hash Hedge-Gewinn", titleAccent: "before",
      ...
      { viz: _e(V2, null), chip: "One trader = lifetime income", title: "Lebenslange Vergütung", titleAccent: "before",
        body: "Every trader is locked to you for life. You earn from every single purchase they make." },
      { viz: _e(V3, null), chip: "Better than exchange offers", title: "Mehr Profit als an Börsen",
        body: "One funded trader with a $25–50K account brings in 5–10× more than a standard exchange referral." },
      { viz: _e(V4, null), chip: "Withdrawals within 72 hours", title: "Schnelle Auszahlungen", titleAccent: "before",
        body: "Request a USDT withdrawal any time. Funds reach your wallet within 72 hours." },
      { viz: _e(V5, null), chip: "Grow automatically", title: "7 Partner-Stufen", titleAccent: "before",
      ...
      // === 3 новые карточки ===
      { viz: _e(V7, null), chip: "Discounts for your audience", title: "Promo-Codes für dein Publikum", titleAccent: "before",
        body: "Get personal discounts for your audience to boost conversion and drive purchases through your link." },
      { viz: _e(V8, null), chip: "Traffic analytics", title: "Flexibles Tracking",
        body: "Build custom links to segment traffic and track conversions in your partner dashboard." },
      { viz: _e(V9, null), chip: "Mehrstufiges Netzwerk", title: "Sub-Partner-Programm",
  ...
  function IncomeSources() {
    ...
    const sources = [
      { n: "01", title: "Verkaufsprovision",
        body: _e(F, null, "Earn ", _e("b", { style: { color: "#fcd535" } }, "bis zu 80%"), " of Hash Hedge profit on every purchase. Referrals are locked to you for life: bring them in once, earn from every future purchase."),
        pill: "Wiederkehrendes Einkommen",
      ...
      { n: "03", title: "Sub-Partner-Programm",
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 760, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Dein Partnerlink kann Einkommen aus drei Quellen gleichzeitig generieren.")
          )
        ),
          ...
          sources.map((s, i) => _e(Reveal, { key: i, delay: String(i + 1) },
            _e("div", { className: "hh-income-card",
              ...
              _e("div", { "aria-hidden": true, style: {
                ...
                pointerVeranstaltungen: "none", userSelect: "none"
              } }, s.n),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 880, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Trader gewinnen and take bis zu 80% of Hash Hedge profit.")
          )
        ),
        ...
        _e("div", { className: "hh-bp-wrap", style: {
            ...
            _e("div", { className: "hh-bp-track-inner", style: {
              ...
              tiers.map((t, i) => {
                ...
                return _e("button", { key: t.lvl, type: "button",
                  ...
                  "aria-label": `Stufe ${t.lvl} ${t.label}, комиссия ${t.pct}%`,
                  style: {
                  ...
                  // чтобы at смене selected (font 22→32) layout не прыгал и линия оставалась ровной
                  _e("div", { style: {
                    height: 38,
                    display: "flex",
                    alignItems: "flex-end",
                  ...
                  _e("div", { style: { fontSize: 11, color: "#52525a", marginTop: 3, fontWeight: 500 } }, "traders/mo")
                );
              })
            )
          ),
          ...
          } }, "Klicke eine Stufe an →  siehe Details")
        ),
        ...
        _e("div", { className: "hh-bp-detail", style: {
          ...
          _e("div", { style: { minWidth: 0 } },
            ...
            _e("div", { className: "hh-bp-detail-line", style: { fontSize: 24, fontWeight: 800, color: "#f5f1e8", letterSpacing: "-0.01em", lineHeight: 1.25 } },
              ...
              _e("span", { style: { color: "#a1a0a4", fontWeight: 700, fontSize: 19 } }, " traders per month")
            )
          ),
          // CTA
        ...
        _e("div", { style: { textAlign: "center", fontSize: 13, color: "#a1a0a4" } },
          "Stufe recalculates automatically each month based on the number of active referred traders"
        )
      )
    );
  }
  ...
  function Calculator() {
    const tiers = [
      { lvl: 1, pct: 50, min: 0,   max: 14,  range: "0–14 Trader" },
      { lvl: 2, pct: 55, min: 15,  max: 49,  range: "15–49 Trader" },
      { lvl: 3, pct: 60, min: 50,  max: 99,  range: "50–99 Trader" },
      { lvl: 4, pct: 65, min: 100, max: 199, range: "100–199 Trader" },
      { lvl: 5, pct: 70, min: 200, max: 399, range: "200–399 Trader" },
      { lvl: 6, pct: 75, min: 400, max: 699, range: "400–699 Trader" },
      { lvl: 7, pct: 80, min: 700, max: 999, range: "700+ Trader" }
    ];
      ...
      _e("div", { className: "container" },
          ...
          _e("div", { className: "hh-calc-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { className: "hh-calc-h2", style: { fontSize: "clamp(32px, 4vw, 48px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Je mehr du bringst,", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "desto größer dein Anteil.")
              )
            ),
        ...
        _e("div", { className: "hh-calc-grid", style: {
          ...
          _e("div", { className: "hh-calc-card", style: {
            ...
            _e("div", { style: { fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a7a80", marginBottom: 24 } }, "Verdienst-Rechner"),
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 } },
              _e("div", { style: { fontSize: 14, color: "#a1a0a4" } }, "Aktive geworbene Trader"),
            ...
            _e("div", { style: { display: "flex", gap: 12, marginTop: 28 } },
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Deine Stufe"),
                _e("div", { style: { fontSize: 26, fontWeight: 800, color: "#fcd535", lineHeight: 1, fontFamily: "Onest, sans-serif" } }, currentTier.pct + "%"),
                _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Stufe " + currentTier.lvl)
              ),
              _e("div", { style: {
                flex: 1,
                padding: "16px 18px",
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Ø / Trader / Mon."),
            ...
            _e("div", { style: { marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--line)" } },
              _e("div", { style: { fontSize: 13, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 } }, "Geschätzte monatliche Auszahlung"),
              ...
              _e("div", { style: { fontSize: 15, color: "#a1a0a4", marginTop: 10 } },
                ...
                " / Jahr · wöchentlich in USDT"
              ),
              _e("p", { style: { fontSize: 11, color: "#6b6a70", lineHeight: 1.5, margin: "18px 0 0" } },
                "Nur zur Veranschaulichung. Tatsächlicher Verdienst hängt von Trader-Aktivität und Kontogröße ab."
              )
            )
          ),
            ...
            tiers.map(t => {
              ...
              return _e("button", { key: t.lvl, type: "button",
                ...
                _e("div", { style: { flex: 1, minWidth: 0, marginLeft: 16, position: "relative", zIndex: 1 } },
                  _e("div", { className: "hh-calc-tier-name", style: { fontSize: 13, fontWeight: 700, color: "#a1a0a4" } }, "Stufe " + t.lvl),
  ...
  function Steps() {
    const steps = [
      { n: "01", chip: "Registrieren",       title: "Registrieren",
      ...
      { n: "03", chip: "Promotion",       title: "Trader gewinnen",
        body: "Share your link on socials, Telegram channels, YouTube, blogs or personal recommendations." },
      { n: "04", chip: "Verdienst",             title: "Bezahlt werden",
        body: "Erhalte bis zu 80% of Hash Hedge profit for referred traders. Payouts in USDT within 72 hours." }
    ];
      ...
      _e("div", { className: "container" },
        ...
        _e(Reveal, null,
          _e("div", { className: "hh-steps-head", style: { display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 60, alignItems: "end", marginBottom: 56 } },
            ...
            _e("p", { style: { fontSize: 16, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } }, "Join 2,500+ partners already verdienen with Hash Hedge.")
          )
        ),
              ...
              _e("div", { className: "hh-cab-top-right", style: { display: "flex", alignItems: "center", gap: 10 } },
                _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10, padding: "6px 12px", border: "1px solid rgba(74,222,128,0.4)", borderRadius: 100, background: "rgba(8,8,10,0.5)" } },
                  ...
                  _e("div", { style: { lineHeight: 1.2 } },
                    ...
                    _e("div", { style: { fontSize: 10, color: "#a1a0a4" } }, "Dein persönlicher Manager")
                  )
                ),
        ...
        _e(Reveal, { delay: "3" },
          _e("div", { className: "hh-cab-explainers", style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 } },
            [
              ...
              { paths: ["M22 11.08V12a10 10 0 1 1-5.93-9.14", "M22 4L12 14.01l-3-3"], t: "Sub-affiliate statistics", b: "Track Vergütung from all levels: your direct partners and their referrals." },
  ...
  function PartnerContent() {
    ...
    const videos = [
      ...
      { id: "oz_72s2S5Xc", title: "Platform & Konditionen breakdown",                                     author: "@cryptoschool",views: "41K"  },
          ...
          _e("div", { className: "hh-yt-head", style: { display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 60, alignItems: "end", marginBottom: 40 } },
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.08, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", margin: 0 } },
                "What helps partners", _e("br", null), _e("span", { style: { color: "#fcd535" } }, "verdienen")
              )
            ),
          ...
          _e(Reveal, { delay: "1" },
            _e("a", {
              ...
              _e("div", { style: { position: "relative", aspectRatio: "16/9", background: `url(https://img.youtube.com/vi/${hero.id}/maxresdefault.jpg) center / cover, #111`, flexShrink: 0 } },
                _e(PlayBtn, { size: 72 }),
                _e("div", { style: { position: "absolute", top: 14, left: 14, display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 11px", borderRadius: 100, background: "rgba(8,8,10,0.78)", backdropFilter: "blur(10px)", border: "1px solid rgba(255,255,255,0.12)", fontSize: 11, fontWeight: 700, color: "#fcd535", letterSpacing: "0.08em", textTransform: "uppercase" } }, "★ Хит views")
              ),
              _e("div", { style: { padding: "22px 24px 24px", flex: 1 } },
                _e("div", { style: { fontSize: 12, fontWeight: 700, color: "#fcd535", letterSpacing: "0.06em", marginBottom: 10 } }, hero.author + " · " + hero.views + " views"),
  ...
  function Veranstaltungen() {
    ...
    const events = [
      // [0] = hero big
      { flag: "🇦🇪", city: "Dubai",     year: "October 2025", role: "Organisator", title: "WSCT Dubai · Live Tournament",     img: "https://hash-hedge-partner.vercel.app/assets/event-dubai.jpg" },
      // [1], [2] = stacked справа
      { flag: "🇷🇺", city: "Moskau",    year: "2025",          role: null,           title: "Partner at Blockchain Forum",     img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/event-blockchain-forum.jpg" },
      { flag: "🇧🇷", city: "São Paulo", year: "2025",          role: "Organisator", title: "WSCT Brazil · Live Tournament",   img: "https://hash-hedge-partner.vercel.app/assets/event-saopaulo.jpeg" },
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "Moskau",    year: "2026",          role: null,           title: "Partner-Meetup",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "Moskau",    year: "2026",          role: "Organisator", title: "Top-Affiliate-Awards",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇷🇺", city: "Moskau",    year: "2026",          role: "Hash Hedge Ambassador", title: "Nikita Anufriev",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇷🇺", city: "Moskau",    year: "2026",          role: null,           title: "Partner-Meetup",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
    const Card = ({ ev, size }) => _e("div", {
      ...
      _e("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 45%, rgba(0,0,0,0.88) 100%)", pointerVeranstaltungen: "none" } }),
  ...
  function TelegramCommunity() {
    ...
    const channelsBase = [
      ...
      { ic: "📣", name: "Partner chat",   sub: "Друзья, всем привет! Напоминаем…",     time: "ПТ",     unread: 13 },
    ...
    const tgScenes = [
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Максим · Алматы 🇰🇿: только что прошёл Stufe 3 🔥",              time: "сейчас",  unread: 1 } } },
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Olga · Moskau: спасибо за промо-материалы, забрала 🤝",          time: "сейчас",  unread: 3 } } }
    ];
    ...
    return _e("section", { id: "telegram", "data-no-glow": true,
      ...
      _e("div", { "aria-hidden": true, className: "glow", style: {
        ...
        filter: "blur(120px)", opacity: 0.07, pointerVeranstaltungen: "none", zIndex: 0
      } }),
      _e("style", null, `
            ...
            _e("div", { ref: tgRef, style: { maxWidth: 380, margin: "0 auto", position: "relative", opacity: 1 } },
              _e("div", {
                ...
                _e("div", { style: { background: "#0e0e10", borderRadius: 40, overflow: "hidden", position: "relative" } },
                  ...
                  _e("div", { style: { padding: "16px 14px 12px", display: "grid", gridTemplateColumns: "44px 1fr 44px", gap: 8, alignItems: "center" } },
                    ...
                    _e("div", { style: { textAlign: "center" } },
                      ...
                      _e("div", { style: { fontSize: 12, color: "#7d8590" } },
                        "332 members, ", _e("span", { style: { color: "#4ade80" } }, "146 online")
                      )
                    ),
                  ...
                  // Затем в активном канале «Partner chat» по сценарию меняется sub/badge — имитация переписки.
                  _e("div", { style: { display: "flex", flexDirection: "column", borderTop: "0.5px solid rgba(255,255,255,0.06)" } },
                    channels.map((ch, i) => _e("div", { key: i,
                      style: {
                        ...
                        // v10.7: opacity 1 forever — раньше зависел от tgInView, и на мобиле IO с threshold 0.3
        ...
        _e("div", { className: "hh-support-grid", style: {
          ...
          _e(Reveal, null,
            _e("div", { style: {
              ...
              _e("img", { src: SUP_BASE + "assets/tati.jpg", alt: "Tati — Leiterin Affiliates",
              ...
              _e("div", { className: "hh-tati-badge", style: {
                ...
                _e("div", null,
                  ...
                  _e("div", { style: { fontSize: 12, color: "#cfcfd3", marginTop: 2 } }, "Leiterin Affiliates")
                ),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "Häufig gestellte Fragen"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "Alles, was du über das Partnerprogramm wissen musst.")
          )
        ),
        _e(Reveal, { delay: "1" },
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 1 } },
        _e(Reveal, null,
          ...
          _e("div", {
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerVeranstaltungen: "none", opacity: 0.6 } },
            ...
            // Точки на линии — HTML divs (forever идеальные круги, не подвержены preserveAspectRatio none).
            // Внешняя обёртка центрирует точку (translate -50%,-50%), внутренние div'ы анимируют scale/opacity.
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerVeranstaltungen: "none" } },
            ...
            _e("div", { "aria-hidden": true, style: {
              position: "absolute", inset: 0, pointerVeranstaltungen: "none",
  ...
  function Footer() {
    const columns = [
      { t: "Produkt", l: [
        ...
        { label: "Partnerprogramm",  href: "https://www.hashhedge.com/affiliateprogram" },
        { label: "Blog",                   href: "https://www.hashhedge.com/blog" },
        { label: "Benutzerhandbuch",            href: "https://hashhedge.gitbook.io/hashhedge-user-guide" }
      ]},
      { t: "Unternehmen", l: [
        { label: "Support", href: "https://t.me/hashhedgesupportbot" },
        { label: "FAQ",       href: "https://www.hashhedge.com/faq" },
        { label: "Karriere",  href: "https://www.hashhedge.com/vacancies" }
      ]},
      { t: "Rechtliches", l: [
        { label: "Datenschutz", href: "https://www.hashhedge.com/privacy-policy" },
        { label: "AGB",       href: "https://www.hashhedge.com/terms-and-conditions" },
        { label: "Geschäftsbedingungen",        href: "https://www.hashhedge.com/commercial-terms" },
        { label: "Partnerrichtlinien",        href: "https://www.hashhedge.com/affiliate-politics" }
      ]}
    ];
    const partners = [
    ...
    return _e("footer", { style: { padding: "88px 0 64px", background: "var(--bg-elev)", borderTop: "1px solid var(--line)" } },
      _e("div", { className: "container", style: { maxWidth: 1180 } },
        _e("div", { className: "hh-footer-grid", style: { display: "grid", gridTemplateColumns: "1.25fr repeat(3, 1fr)", gap: 86, marginBottom: 92 } },
          _e("div", { style: { paddingTop: 4 } },
            ...
            _e("p", { style: { fontSize: 15, color: "var(--fg-low)", marginTop: 44, lineHeight: 1.45, maxWidth: 260 } },
              "Hash Hedge — prop trading platform: trade crypto and TradFi assets. Manage capital up to $150K."
            )
          ),
        ...
        _e("div", { style: { textAlign: "center" } },
          _e("div", { style: { fontSize: 16, color: "rgba(238,238,243,0.86)", marginBottom: 34 } }, "© 2026 HashHedge. Alle Rechte vorbehalten."),
  ...
  function MobileCTABar() {
    ...
    return _e("div", { className: "hh-mobile-cta",
      style: {
        ...
        pointerVeranstaltungen: show ? "auto" : "none"
      }
    },
  ...
  function App() {
    ...
    return _e("div", { className: "tilda-html-hashhedge hh-with-glow" },
      ...
      // _e(Leaderboard, null),
      // v12.11: PartnerContent («Partner content / What helps partners verdienen») убран — как на RU
      // _e(PartnerContent, null),
      _e(Veranstaltungen, null),
  ...
  if (!document.getElementById("hh-partner-styles")) {
    ...
    st.textContent = `
      ...
      /* v12.11 — ссылка «Verdienst berechnen»: белое подчёркивание + hover-анимация */
      ...
      /* v12.11 — фото Tati: быстрый hover-zoom как у карточек Live-Veranstaltungen */
      ...
      @media (max-width: 980px) {
        ...
        /* v11.0 Veranstaltungen: на планшете top→1кол, bottom→2кол */
      ...
      @media (max-width: 640px) {
        ...
        /* === v10.2 mobile: Veranstaltungen — 1 hero + horizontal slider === */
        .hh-events-grid {
          display: flex !important;
          grid-template-columns: none !important;
          overflow-x: auto !important;
        ...
        /* === (v3.7 #5) Calculator: тексты одного размера, блок «Deine Stufe» компактнее === */
        ...
        /* Компактный блок «Deine Stufe · авто» */
        ...
        /* Veranstaltungen — все 4 карточки одного размера + единый title 18px */
      ...
      @media (max-width: 980px) {
        ...
        /* (4) Veranstaltungen — big card компактнее + горизонтальный слайдер остального */
