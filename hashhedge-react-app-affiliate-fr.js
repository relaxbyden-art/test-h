(function(){
  ...
  function Header() {
    ...
    const nav = [
      { l: "À propos",     h: "#about-program" },
      { l: "Fonctionnement",    h: "#how" },
      { l: "Gains",           h: "#calc" },
      { l: "FAQ",             h: "#faq" },
      { l: "Challenge trading", h: "https://hashhedge.com/", external: true }
    ];
    const langs = [
      ...
      { code: "FR", flag: "🇫🇷", label: "Française",        href: "#", current: true },
  ...
  function HeroCandles() {
    ...
    return _e("div", { "aria-hidden": true, className: "hh-hero-candles",
      style: { position: "absolute", inset: 0, pointerÉvénements: "none", zIndex: 0 }
    },
  ...
  function LivePartnerCard() {
    ...
    const payoutPool = [
      { flag: "🇷🇺", name: "Сергей",     city: "Moscou",       amt: 1850 },
    ...
    return _e("div", { className: "hh-live-card hh-glass",
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        pointerÉvénements: "none", zIndex: 1, borderRadius: "26px 26px 0 0"
      } }),
      ...
      _e("div", { "aria-hidden": true, style: {
        ...
        opacity: 0.7, pointerÉvénements: "none"
      } }),
      ...
      _e("div", { style: { padding: "20px 22px 22px", borderBottom: "1px solid rgba(255,255,255,0.05)" } },
        ...
        _e("div", { style: { marginTop: 20 } },
          ...
          _e("div", { style: { position: "relative", height: 8, borderRadius: 6, background: "rgba(255,255,255,0.06)", overflow: "hidden", border: "1px solid rgba(255,255,255,0.04)" } },
            ...
            // Shimmer-полоска
            _e("div", { style: {
              position: "absolute", inset: "0 24% 0 0", borderRadius: 6, overflow: "hidden", pointerÉvénements: "none"
            } },
              _e("div", { style: {
  ...
  function Hero() {
    ...
    // matrix-стене), большой H1 в 4 строки с акцентом на «gagner ensemble», 2 CTA,
    // ссылка «Calculer vos gains», блок Trustpilot снизу с 4-stat ряду.
    ...
    return _e("section", {
      ...
      _e("div", { "aria-hidden": "true", className: "hh-partner-hero-bg", style: {
        ...
        pointerÉvénements: "none", zIndex: 0
      } }),
      ...
      _e("div", { "aria-hidden": "true", style: {
        ...
        pointerÉvénements: "none", zIndex: 1
      } }),
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 2 } },
        _e(Reveal, null,
          _e("div", { className: "hh-partner-hero-text", style: { maxWidth: 720 } },
            ...
            _e("h1", { className: "hh-partner-hero-h1",
              ...
              "Promouvoir une firme", _e("br", null),
              "prop crypto de premier plan", _e("br", null),
              "à travers le monde et", _e("br", null),
              _e("span", { style: { color: "#fcd535" } }, "gagner ensemble")
            ),
            _e("p", { className: "hh-partner-hero-sub", style: {
              ...
              " pour chaque trader que vous parrainez — payé chaque semaine en USDT, à vie."
            ),
        ...
        _e("div", { className: "hh-partner-hero-stats", style: {
          ...
          _e("div", null,
            _e("div", { style: { fontSize: 10, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#a1a0a4", marginBottom: 8, whiteSpace: "nowrap" } }, "Partenariat avec une plateforme de confiance"),
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Traders financés mondialement")
          ),
          // $12M+
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Payé aux traders")
          ),
          // 4.4/5
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
          ...
          _e("div", { style: { borderLeft: "1px solid rgba(255,255,255,0.08)", paddingLeft: 22 } },
            ...
            _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Pays desservis")
          )
        )
      )
    );
  ...
  function AboutProgram() {
    const cards = [
      { v: "jusqu'à 80%", t: "des bénéfices HashHedge",         b: "Part de revenus la plus élevée du secteur par trader parrainé." },
      { v: "Chaque semaine", t: "paiements en USDT",            b: "Vos gains arrivent dans votre wallet chaque lundi." },
      { v: "À vie", t: "commissions",                 b: "Vous gagnez tant que le trader reste actif." },
      { v: "Minutes", t: "pour être validé",                   b: "Validation rapide, formalités minimales, lien instantané." }
    ];
          ...
          _e("div", { className: "hh-about-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { style: { fontSize: "clamp(36px, 4.8vw, 60px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Les meilleures conditions", _e("br", null),
                "d'affiliation ", _e("span", { style: { color: "#fcd535" } }, "du secteur.")
              )
            ),
            _e("p", { style: { fontSize: 17, color: "#a1a0a4", lineHeight: 1.55, margin: 0 } },
              "HashHedge donne aux traders crypto ", _e("strong", { style: { color: "#f5f1e8" } }, "$5,000 to $100,000"),
              " pour trader sans risque. Votre rôle est simple — amenez-nous ces traders. En retour, vous obtenez une part des revenus qu'ils génèrent, aux conditions les plus généreuses qu'une firme prop puisse offrir."
            )
          )
        ),
          ...
          cards.map((c, i) => _e(Reveal, { key: i, delay: String((i % 4) + 1) },
            _e("div", { className: "hh-about-card", style: {
              ...
              _e("div", { style: {
                ...
                marginBottom: 12,
                fontFamily: "Onest, sans-serif",
                textTransform: c.v === "jusqu'à 80%" || c.v === "Minutes" || c.v === "À vie" || c.v === "Chaque semaine" ? "none" : "uppercase"
              } }, c.v),
  ...
  function WhyPartner() {
    ...
    const V1 = () => isMobile
      ? _e("div", { className: "hh-v1 hh-v1-mobile", style: { width: "100%", textAlign: "center", padding: "0 4px", display: "flex", flexDirection: "column", justifyContent: "center", height: "100%" } },
          _e("div", { style: { fontSize: 38, fontWeight: 900, color: "#fcd535", lineHeight: 1, letterSpacing: "-0.03em" } }, "jusqu'à 80%"),
    ...
    // V9 — Réseau multi-niveau. Картинка увеличена (viewBox шире), круги с непрозрачным фоном.
    const V9 = () => _e("div", { style: { width: "100%", padding: 0, position: "relative" } },
      _e("svg", { width: "100%", height: 180, viewBox: "0 0 220 130", style: { display: "block" } },
        ...
        _e("text", { x: 110, y: 33, textAnchor: "middle", style: { fontSize: 11, fontWeight: 800, fill: "#13111c" } }, "VOUS"),
    ...
    const cards = [
      { viz: _e(V1, null), chip: "Top in the prop industry", title: "Jusqu'à 80% des bénéfices Hash Hedge", titleAccent: "before",
      ...
      { viz: _e(V2, null), chip: "One trader = lifetime income", title: "Commissions à vie", titleAccent: "before",
        body: "Every trader is locked to you for life. You earn from every single purchase they make." },
      { viz: _e(V3, null), chip: "Better than exchange offers", title: "Plus de profit que les exchanges",
        body: "One funded trader with a $25–50K account brings in 5–10× more than a standard exchange referral." },
      { viz: _e(V4, null), chip: "Withdrawals within 72 hours", title: "Paiements rapides", titleAccent: "before",
        body: "Request a USDT withdrawal any time. Funds reach your wallet within 72 hours." },
      { viz: _e(V5, null), chip: "Grow automatically", title: "7 niveaux de partenariat", titleAccent: "before",
      ...
      // === 3 новые карточки ===
      { viz: _e(V7, null), chip: "Discounts for your audience", title: "Codes promo pour votre audience", titleAccent: "before",
        body: "Get personal discounts for your audience to boost conversion and drive purchases through your link." },
      { viz: _e(V8, null), chip: "Traffic analytics", title: "Suivi flexible",
        body: "Build custom links to segment traffic and track conversions in your partner dashboard." },
      { viz: _e(V9, null), chip: "Réseau multi-niveau", title: "Programme sous-affilié",
  ...
  function IncomeSources() {
    ...
    const sources = [
      { n: "01", title: "Commission sur ventes",
        body: _e(F, null, "Earn ", _e("b", { style: { color: "#fcd535" } }, "jusqu'à 80%"), " of Hash Hedge profit on every purchase. Referrals are locked to you for life: bring them in once, earn from every future purchase."),
        pill: "Revenu récurrent",
      ...
      { n: "03", title: "Programme sous-affilié",
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 760, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Votre lien d'affiliation peut générer des revenus de trois sources en même temps.")
          )
        ),
          ...
          sources.map((s, i) => _e(Reveal, { key: i, delay: String(i + 1) },
            _e("div", { className: "hh-income-card",
              ...
              _e("div", { "aria-hidden": true, style: {
                ...
                pointerÉvénements: "none", userSelect: "none"
              } }, s.n),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 880, margin: "0 auto 48px" } },
            ...
            _e("p", { style: { fontSize: 17, color: "#a1a0a4" } }, "Amener des traders and take jusqu'à 80% of Hash Hedge profit.")
          )
        ),
        ...
        _e("div", { className: "hh-bp-wrap", style: {
            ...
            _e("div", { className: "hh-bp-track-inner", style: {
              ...
              tiers.map((t, i) => {
                ...
                return _e("button", { key: t.lvl, type: "button",
                  ...
                  "aria-label": `Niveau ${t.lvl} ${t.label}, комиссия ${t.pct}%`,
                  style: {
          ...
          } }, "Cliquez sur un niveau →  voir les détails")
        ),
        ...
        _e("div", { style: { textAlign: "center", fontSize: 13, color: "#a1a0a4" } },
          "Niveau recalculates automatically each month based on the number of active referred traders"
        )
      )
    );
  }
  ...
  function Calculator() {
    const tiers = [
      { lvl: 1, pct: 50, min: 0,   max: 14,  range: "0–14 traders" },
      { lvl: 2, pct: 55, min: 15,  max: 49,  range: "15–49 traders" },
      { lvl: 3, pct: 60, min: 50,  max: 99,  range: "50–99 traders" },
      { lvl: 4, pct: 65, min: 100, max: 199, range: "100–199 traders" },
      { lvl: 5, pct: 70, min: 200, max: 399, range: "200–399 traders" },
      { lvl: 6, pct: 75, min: 400, max: 699, range: "400–699 traders" },
      { lvl: 7, pct: 80, min: 700, max: 999, range: "700+ traders" }
    ];
      ...
      _e("div", { className: "container" },
          ...
          _e("div", { className: "hh-calc-head", style: {
            ...
            _e("div", null,
              ...
              _e("h2", { className: "hh-calc-h2", style: { fontSize: "clamp(32px, 4vw, 48px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", color: "#f5f1e8", margin: 0 } },
                "Plus vous amenez,", _e("br", null),
                _e("span", { style: { color: "#fcd535" } }, "plus votre part est grande.")
              )
            ),
        ...
        _e("div", { className: "hh-calc-grid", style: {
          ...
          _e("div", { className: "hh-calc-card", style: {
            ...
            _e("div", { style: { fontSize: 11, fontWeight: 800, letterSpacing: "0.12em", textTransform: "uppercase", color: "#7a7a80", marginBottom: 24 } }, "Calculateur de gains"),
            _e("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 } },
              _e("div", { style: { fontSize: 14, color: "#a1a0a4" } }, "Traders parrainés actifs"),
            ...
            _e("div", { style: { display: "flex", gap: 12, marginTop: 28 } },
              _e("div", { style: {
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Votre niveau"),
                _e("div", { style: { fontSize: 26, fontWeight: 800, color: "#fcd535", lineHeight: 1, fontFamily: "Onest, sans-serif" } }, currentTier.pct + "%"),
                _e("div", { style: { fontSize: 12, color: "#a1a0a4", marginTop: 6 } }, "Niveau " + currentTier.lvl)
              ),
              _e("div", { style: {
                flex: 1,
                padding: "16px 18px",
                ...
                _e("div", { style: { fontSize: 11, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 6 } }, "Moy / trader / mois"),
            ...
            _e("div", { style: { marginTop: 24, paddingTop: 24, borderTop: "1px solid var(--line)" } },
              _e("div", { style: { fontSize: 13, color: "#7a7a80", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 10 } }, "Paiement mensuel estimé"),
              ...
              _e("div", { style: { fontSize: 15, color: "#a1a0a4", marginTop: 10 } },
                ...
                " / an · payé chaque semaine en USDT"
              ),
              _e("p", { style: { fontSize: 11, color: "#6b6a70", lineHeight: 1.5, margin: "18px 0 0" } },
                "À titre indicatif. Les gains réels dépendent de l'activité des traders et de la taille des comptes."
              )
            )
          ),
            ...
            tiers.map(t => {
              ...
              return _e("button", { key: t.lvl, type: "button",
                ...
                _e("div", { style: { flex: 1, minWidth: 0, marginLeft: 16, position: "relative", zIndex: 1 } },
                  _e("div", { className: "hh-calc-tier-name", style: { fontSize: 13, fontWeight: 700, color: "#a1a0a4" } }, "Niveau " + t.lvl),
  ...
  function Steps() {
    const steps = [
      { n: "01", chip: "S'inscrire",       title: "Inscription",
      ...
      { n: "03", chip: "Promotion",       title: "Amener des traders",
        body: "Share your link on socials, Telegram channels, YouTube, blogs or personal recommendations." },
      { n: "04", chip: "Gains",             title: "Être payé",
        body: "Recevez jusqu'à 80% of Hash Hedge profit for referred traders. Payouts in USDT within 72 hours." }
    ];
              ...
              _e("div", { className: "hh-cab-top-right", style: { display: "flex", alignItems: "center", gap: 10 } },
                _e("div", { style: { display: "inline-flex", alignItems: "center", gap: 10, padding: "6px 12px", border: "1px solid rgba(74,222,128,0.4)", borderRadius: 100, background: "rgba(8,8,10,0.5)" } },
                  ...
                  _e("div", { style: { lineHeight: 1.2 } },
                    ...
                    _e("div", { style: { fontSize: 10, color: "#a1a0a4" } }, "Votre manager dédié")
                  )
                ),
        ...
        _e(Reveal, { delay: "3" },
          _e("div", { className: "hh-cab-explainers", style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 } },
            [
              ...
              { paths: ["M22 11.08V12a10 10 0 1 1-5.93-9.14", "M22 4L12 14.01l-3-3"], t: "Sub-affiliate statistics", b: "Track commissions from all levels: your direct partners and their referrals." },
  ...
  function PartnerContent() {
    ...
    const videos = [
      ...
      { id: "oz_72s2S5Xc", title: "Platform & d'affiliation breakdown",                                     author: "@cryptoschool",views: "41K"  },
  ...
  function Événements() {
    ...
    const events = [
      // [0] = hero big
      { flag: "🇦🇪", city: "Dubai",     year: "October 2025", role: "Organisateur", title: "WSCT Dubai · Live Tournament",     img: "https://hash-hedge-partner.vercel.app/assets/event-dubai.jpg" },
      // [1], [2] = stacked справа
      { flag: "🇷🇺", city: "Moscou",    year: "2025",          role: null,           title: "Partenaires at Blockchain Forum",     img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/event-blockchain-forum.jpg" },
      { flag: "🇧🇷", city: "São Paulo", year: "2025",          role: "Organisateur", title: "WSCT Brazil · Live Tournament",   img: "https://hash-hedge-partner.vercel.app/assets/event-saopaulo.jpeg" },
      // [3..6] = bottom row 4
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: null,           title: "Rencontre Affiliés",              img: "https://hash-hedge-partner.vercel.app/assets/event-moscow.jpg" },
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: "Organisateur", title: "Top Affiliate Awards",        img: "https://hash-hedge-partner.vercel.app/assets/event-award.jpg" },
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: "Ambassadeur Hash Hedge", title: "Nikita Anufriev",         img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/web_29.10.25_397.jpg" },
      { flag: "🇷🇺", city: "Moscou",    year: "2026",          role: null,           title: "Rencontre Affiliés",                img: ((typeof window !== "undefined" && window.__HH_BASE__) || "") + "assets/093samartsevanton.webp" }
    ];
    const Card = ({ ev, size }) => _e("div", {
      ...
      _e("div", { style: { position: "absolute", inset: 0, background: "linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0) 30%, rgba(0,0,0,0) 45%, rgba(0,0,0,0.88) 100%)", pointerÉvénements: "none" } }),
  ...
  function TelegramCommunity() {
    ...
    const channelsBase = [
      ...
      { ic: "📣", name: "Partenaires chat",   sub: "Друзья, всем привет! Напоминаем…",     time: "ПТ",     unread: 13 },
    ...
    const tgScenes = [
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Максим · Алматы 🇰🇿: только что прошёл Niveau 3 🔥",              time: "сейчас",  unread: 1 } } },
      ...
      { activeIdx: 2, overrides: { 2: { sub: "Olga · Moscou: спасибо за промо-материалы, забрала 🤝",          time: "сейчас",  unread: 3 } } }
    ];
    ...
    return _e("section", { id: "telegram", "data-no-glow": true,
      ...
      _e("div", { "aria-hidden": true, className: "glow", style: {
        ...
        filter: "blur(120px)", opacity: 0.07, pointerÉvénements: "none", zIndex: 0
      } }),
      _e("style", null, `
            ...
            _e("div", { ref: tgRef, style: { maxWidth: 380, margin: "0 auto", position: "relative", opacity: 1 } },
              _e("div", {
                ...
                _e("div", { style: { background: "#0e0e10", borderRadius: 40, overflow: "hidden", position: "relative" } },
                  ...
                  // Затем в активном канале «Partenaires chat» по сценарию меняется sub/badge — имитация переписки.
        ...
        _e("div", { className: "hh-support-grid", style: {
          ...
          _e(Reveal, null,
            _e("div", { style: {
              ...
              _e("img", { src: SUP_BASE + "assets/tati.jpg", alt: "Tati — Responsable Affiliés",
              ...
              _e("div", { className: "hh-tati-badge", style: {
                ...
                _e("div", null,
                  ...
                  _e("div", { style: { fontSize: 12, color: "#cfcfd3", marginTop: 2 } }, "Responsable Affiliés")
                ),
      ...
      _e("div", { className: "container" },
        _e(Reveal, null,
          _e("div", { style: { textAlign: "center", maxWidth: 720, margin: "0 auto 48px" } },
            ...
            _e("h2", { style: { fontSize: "clamp(36px, 5vw, 56px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.025em", color: "#f5f1e8", marginBottom: 16 } }, "Questions fréquentes"),
            _e("p", { style: { fontSize: 16, color: "#a1a0a4" } }, "Tout ce que vous devez savoir sur le programme d'affiliation.")
          )
        ),
        _e(Reveal, { delay: "1" },
      ...
      _e("div", { className: "container", style: { position: "relative", zIndex: 1 } },
        _e(Reveal, null,
          ...
          _e("div", {
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerÉvénements: "none", opacity: 0.6 } },
            ...
            _e("div", { "aria-hidden": true, style: { position: "absolute", inset: 0, pointerÉvénements: "none" } },
            ...
            _e("div", { "aria-hidden": true, style: {
              position: "absolute", inset: 0, pointerÉvénements: "none",
  ...
  function Footer() {
    const columns = [
      { t: "Produit", l: [
        ...
        { label: "Programme d'affiliation",  href: "https://www.hashhedge.com/affiliateprogram" },
        { label: "Blog",                   href: "https://www.hashhedge.com/blog" },
        { label: "Guide utilisateur",            href: "https://hashhedge.gitbook.io/hashhedge-user-guide" }
      ]},
      { t: "Société", l: [
        { label: "Support", href: "https://t.me/hashhedgesupportbot" },
        { label: "FAQ",       href: "https://www.hashhedge.com/faq" },
        { label: "Carrières",  href: "https://www.hashhedge.com/vacancies" }
      ]},
      { t: "Mentions légales", l: [
        { label: "Confidentialité", href: "https://www.hashhedge.com/privacy-policy" },
        { label: "Conditions",       href: "https://www.hashhedge.com/terms-and-conditions" },
        { label: "Conditions commerciales",        href: "https://www.hashhedge.com/commercial-terms" },
        { label: "Politique partenaire",        href: "https://www.hashhedge.com/affiliate-politics" }
      ]}
    ];
    const partners = [
    ...
    return _e("footer", { style: { padding: "88px 0 64px", background: "var(--bg-elev)", borderTop: "1px solid var(--line)" } },
      _e("div", { className: "container", style: { maxWidth: 1180 } },
        ...
        _e("div", { style: { textAlign: "center" } },
          _e("div", { style: { fontSize: 16, color: "rgba(238,238,243,0.86)", marginBottom: 34 } }, "© 2026 HashHedge. Tous droits réservés."),
  ...
  function MobileCTABar() {
    ...
    return _e("div", { className: "hh-mobile-cta",
      style: {
        ...
        pointerÉvénements: show ? "auto" : "none"
      }
    },
  ...
  if (!document.getElementById("hh-partner-styles")) {
    ...
    st.textContent = `
      ...
      /* v12.11 — ссылка «Calculer vos gains»: белое подчёркивание + hover-анимация */
      ...
      /* v12.11 — фото Tati: быстрый hover-zoom как у карточек Événements live */
      ...
      @media (max-width: 980px) {
        ...
        /* v11.0 Événements: на планшете top→1кол, bottom→2кол */
      ...
      @media (max-width: 640px) {
        ...
        /* === v10.2 mobile: Événements — 1 hero + horizontal slider === */
        .hh-events-grid {
          display: flex !important;
          grid-template-columns: none !important;
          overflow-x: auto !important;
        ...
        /* === (v3.7 #5) Calculator: тексты одного размера, блок «Votre niveau» компактнее === */
        ...
        /* Компактный блок «Votre niveau · авто» */
        ...
        /* Événements — все 4 карточки одного размера + единый title 18px */
      ...
      @media (max-width: 980px) {
        ...
        /* (4) Événements — big card компактнее + горизонтальный слайдер остального */
